...
public class V5ProxyMetadataProvider implements MetadataProvider {
    ...
    public V5ProxyMetadataProvider(MQAdminExt mqAdminExt, Optional<String> namespace) {
        this(mqAdminExt, namespace, null, null);
    }

    /**
     * Construct a new V5ProxyMetadataProvider with consumer wrapper for route-based message query.
     *
     * @param mqAdminExt      the MQAdminExt instance for Remoting-based metadata operations. Must not be null.
     * @param namespace       optional namespace scope.
     * @param consumerWrapper pull consumer wrapper for route-based message query.
     * @param rmqConfigure    RMQ configuration for ACL and TLS settings.
     * @throws IllegalArgumentException if mqAdminExt is null
     */
    public V5ProxyMetadataProvider(MQAdminExt mqAdminExt, Optional<String> namespace,
                                   AutoCloseConsumerWrapper consumerWrapper, RMQConfigure rmqConfigure) {
