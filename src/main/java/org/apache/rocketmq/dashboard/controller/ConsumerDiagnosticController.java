...
@Controller
@RequestMapping("/consumer-diagnostic")
@Permission
public class ConsumerDiagnosticController {
    ...
    @RequestMapping(value = "/diagnose.query", method = RequestMethod.GET)
    @ResponseBody
    public ConsumerDiagnosticReport diagnoseConsumerGroup(@RequestParam("consumerGroup") String consumerGroup,
                                                           @RequestParam(value = "topic", required = false) String topic) {
        return consumerDiagnosticService.diagnoseConsumerGroup(consumerGroup, topic);
    }
}
