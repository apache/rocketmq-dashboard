...
public class ProxyController {
    ...
    @RequestMapping(value = "/proxyDetailConfig.query", method = RequestMethod.GET)
    @ResponseBody
    public Object queryProxyDetailConfig(@RequestParam String proxyAddress) throws MQBrokerException {
        return proxyService.getProxyDetailConfig(proxyAddress);
    }
