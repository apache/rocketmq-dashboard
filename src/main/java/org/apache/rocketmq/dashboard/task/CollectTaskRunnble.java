...
public class CollectTaskRunnble implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            list.add(date.getTime() + "," + BigDecimal.valueOf(inTPS).setScale(5, BigDecimal.ROUND_HALF_UP) + "," + inMsgCntToday + "," + BigDecimal.valueOf(outTPS).setScale(5, BigDecimal.ROUND_HALF_UP) + "," + outMsgCntToday);
