...
class MetadataServiceTest {
    ...
    @Test
    void listConsumerGroupsPageShouldForwardNormalizedSubscriptionModeTest() {
        when(apacheProvider.listConsumerGroupsPage("instance-a", null, "order", "Pop", 2, 2))
                .thenReturn(PageResult.empty(2, 2));

        metadataService.listConsumerGroupsPage("instance-a", null, " order ", " pop ", 2, 2);

        verify(apacheProvider).listConsumerGroupsPage("instance-a", null, "order", "Pop", 2, 2);
    }
