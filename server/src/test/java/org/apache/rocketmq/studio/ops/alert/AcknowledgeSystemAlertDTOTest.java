...
class AcknowledgeSystemAlertDTOTest {
    ...
    @Test
    void validAcknowledgeShouldPassValidation() {
        AcknowledgeSystemAlertDTO request = AcknowledgeSystemAlertDTO.builder().id(3L).build();

        assertThat(validator.validate(request)).isEmpty();
        assertThat(request.getId()).isEqualTo(3L);
    }
}
