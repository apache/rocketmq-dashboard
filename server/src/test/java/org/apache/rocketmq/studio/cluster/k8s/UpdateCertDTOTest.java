...
class UpdateCertDTOTest {
    ...
    void idShouldBeRequired() {
        UpdateCertDTO request = UpdateCertDTO.builder().build();
    ...
    @Test
    void invalidTypeShouldBeRejected() {
        UpdateCertDTO request = UpdateCertDTO.builder().id(1L).type("self-signed").build();
