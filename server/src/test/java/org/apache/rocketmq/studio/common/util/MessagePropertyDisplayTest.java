...
class MessagePropertyDisplayTest {
    ...
    void limitPropertiesShouldNotSplitASurrogatePairTest() {
        ...
        String value = "a".repeat(MessagePropertyDisplay.MAX_PROPERTY_VALUE_CODE_POINTS - 1) + EMOJI + "tail";
        ...
        assertThat(abbreviated)
                .isEqualTo("a".repeat(MessagePropertyDisplay.MAX_PROPERTY_VALUE_CODE_POINTS - 1) + EMOJI + "...");
    }

    @Test
    void limitPropertiesShouldKeepASupplementaryCharacterThatFitsTheCapTest() {
        String value = "a".repeat(MessagePropertyDisplay.MAX_PROPERTY_VALUE_CODE_POINTS - 2) + EMOJI + "tail";
        String abbreviated = MessagePropertyDisplay.limitProperties(Map.of("big", value)).get("big");
        assertThat(hasUnpairedSurrogate(abbreviated)).isFalse();
        ...
        assertThat(abbreviated)
                .isEqualTo("a".repeat(MessagePropertyDisplay.MAX_PROPERTY_VALUE_CODE_POINTS - 2) + EMOJI + "t...");
    }
    ...
    void hasOversizedPropertyShouldCountCodePointsNotCharsTest() {
        ...
        String atCap = EMOJI.repeat(600) + "a".repeat(MessagePropertyDisplay.MAX_PROPERTY_VALUE_CODE_POINTS - 600);
