...
class InstanceMetricsToolHandlerTest {

    @Mock
    private MetricsService metricsService;

    @InjectMocks
    private InstanceMetricsToolHandler handler;

    @Test
    void executeShouldQueryTheDedicatedDataSourceAndProjectSeriesTest() {
        assertThat(handler.name()).isEqualTo("rmq.instance.metrics");
        ...
        MetricDataVO result = handler.execute(new InstanceMetricsInput(
                "instance-a", "rocketmq_topic_tps", null, null,
