...
class ToolCatalogTest {
    ...
    void messageQueriesAdvertiseBoundedPagingAndOptionalBodiesTest() {
        ToolCatalog catalog = new ToolCatalog(new DefaultResourceLoader());
    ...
    @Test
    @SuppressWarnings("unchecked")
    void messageTraceAdvertisesOptionalCustomTraceTopicTest() {
        ...
        assertThat((java.util.List<String>) inputSchema.get("required"))
                .doesNotContain("traceTopic");
    }

    @Test
    void rejectsInvalidMessageQueryPagingThroughTheRuntimeSchemaTest() {
        ToolCatalog catalog = new ToolCatalog(new DefaultResourceLoader());
        ...
        for (String toolName : new String[]{"rmq.message.query", "rmq.message.query_by_topic"}) {
            ...
            for (Map<String, Object> invalid : List.<Map<String, Object>>of(
                    Map.of("instanceId", "instance-a", "topicName", "TopicA", "page", 0),
                    Map.of("instanceId", "instance-a", "topicName", "TopicA", "pageSize", 101))) {
