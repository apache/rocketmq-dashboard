...
class ConsumerGroupControllerTest extends WebMvcAuthTestSupport {
    ...
    @Test
    void listConsumerGroupsPageShouldPassSubscriptionModeFilter() throws Exception {
        PageResult<ConsumerGroupVO> page = PageResult.of(List.of(), 7, 1, 20);
        when(metadataService.listConsumerGroupsPage("instance-a", "cluster-a", "orders", "Pop", 1, 20))
                .thenReturn(page);
        ...
        verify(metadataService).listConsumerGroupsPage("instance-a", "cluster-a", "orders", "Pop", 1, 20);
    }
