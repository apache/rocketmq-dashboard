...
public class LiteTopicController {
    ...
    public Result<LiteTopicSessionVO> getSession(@PathVariable String sessionId) {
    ...
    @GetMapping("/quota")
    public Result<LiteTopicQuotaVO> getQuota(@RequestParam(required = false) String namespace) {
