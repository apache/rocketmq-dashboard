...
public class BrokerRuntimeInfoToolHandler
        implements ToolHandler<ClusterInput, BrokerRuntimeInfoToolHandler.Output> {

    private final ClusterProvider clusterProvider;

    @Override
    public String name() {
        return "rmq.broker.runtime_info";
    }
    ...
    public Output execute(
        ...
        return new Output(context.cluster(), clusterProvider.discoverBrokers(context.cluster(), null));
    }

    public record Output(String cluster, List<BrokerVO> brokers) { }
}
