...
public class NameServerConfigDiffToolHandler implements ToolHandler<ClusterInput, Object> {

    private final NameServerConfigDiffService configDiffService;

    @Override
    public String name() {
        return "rmq.nameserver.config.diff";
    }
    ...
    @Override
    public Object execute(ClusterInput input, ToolExecutionContext context) {
        return configDiffService.compareForInstance(context.cluster());
    }
}
