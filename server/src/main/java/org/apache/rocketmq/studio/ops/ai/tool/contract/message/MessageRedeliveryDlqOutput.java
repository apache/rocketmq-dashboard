...
public record MessageRedeliveryDlqOutput(
        int matched,
        int resent,
        int failed,
        String outcome,
    ...
    public static MessageRedeliveryDlqOutput from(DLQResendResultVO result) {
        return new MessageRedeliveryDlqOutput(
                result.getMatched(),
                result.getResent(),
                result.getFailed(),
                result.getOutcome(),
                result.isScanIncomplete(),
