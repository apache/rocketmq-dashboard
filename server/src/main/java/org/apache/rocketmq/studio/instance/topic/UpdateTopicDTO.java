...
public class UpdateTopicDTO {
    ...
    // Required so an explicit drain-to-zero reaches the broker instead of being read as
    // "not provided" and refilled from the stored value or the creation default of 8.
