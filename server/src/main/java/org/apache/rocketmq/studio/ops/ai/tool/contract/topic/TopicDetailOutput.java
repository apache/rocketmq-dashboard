...
public record TopicDetailOutput(
        String instanceId,
        String name,
        String clusterId,
        TopicType type,
        ...
        List<Route> routes,
        List<TopicQueueStatsItem> queueStats) {

    public static TopicDetailOutput from(
            TopicVO topic, String instanceId,
        ...
        return new TopicDetailOutput(
                ...
                groups,
                routeList,
                queueStats == null || queueStats.isEmpty() ? null : List.copyOf(queueStats));
    }
