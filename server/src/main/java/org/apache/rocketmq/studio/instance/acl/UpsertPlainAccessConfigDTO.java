...
/**
 * Write payload for creating or updating a plain access account. Write endpoints accept this
 * validated DTO instead of the read-side VO; {@code secretKey} may be left blank on updates, in
