...
export const mockInstances: Instance[] = [
  {
    ...
    enRemark: 'Direct instance 1 - core trading path (direct NameServer)',
    type: 'DIRECT',
  ...
  },
  {
    ...
    enRemark: 'Direct instance 2 - risk control and audit path (direct NameServer)',
    type: 'DIRECT',
  ...
  },
  {
    ...
    enRemark: 'Proxy instance 1 - e-commerce trading main path',
    type: 'PROXY_CLUSTER',
  ...
  },
  {
    ...
    enRemark: 'Proxy instance 2 - marketing and membership path',
    type: 'PROXY_CLUSTER',
  ...
  },
  {
    ...
    enRemark: 'Proxy instance 3 - logistics and big-data path',
    type: 'PROXY_LOCAL',
