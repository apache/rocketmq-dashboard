...
export const topics: Topic[] = [
  // NORMAL topics (4)
  {
    ...
    remark: '订单创建事件通知',
    enRemark: 'Order creation event notifications',
  ...
  },
  {
    ...
    remark: '用户行为日志同步',
    enRemark: 'User behavior log sync',
  ...
  },
  {
    ...
    remark: '系统日志收集与分发',
    enRemark: 'System log collection and distribution',
  ...
  },
  {
    ...
    remark: '邮件通知触发',
    enRemark: 'Email notification triggers',
  ...
  // FIFO topics (2)
  {
    ...
    remark: '库存同步顺序消息',
    enRemark: 'Inventory sync ordered messages',
  ...
  },
  {
    ...
    remark: '支付流程顺序处理',
    enRemark: 'Payment flow ordered processing',
  ...
  // DELAY topics (2)
  {
    ...
    consumerGroupCount: 3,
    remark: '延迟推送通知调度',
    enRemark: 'Delayed push notification scheduling',
  ...
  },
  {
    ...
    consumerGroupCount: 2,
    remark: '定时任务触发器',
    enRemark: 'Scheduled task triggers',
  ...
  // TRANSACTION topics (2)
  {
    ...
    consumerGroupCount: 5,
    remark: '支付回调事务处理',
    enRemark: 'Payment callback transactional processing',
  ...
  },
  {
    ...
    consumerGroupCount: 4,
    remark: '订单确认事务消息',
    enRemark: 'Order confirmation transactional messages',
  ...
  // LITE topics (2)
  {
    ...
    remark: 'AI 对话会话消息分发',
    enRemark: 'AI conversation message routing',
  ...
  },
  {
    ...
    consumerGroupCount: 2,
    remark: 'AI 任务调度与状态同步',
    enRemark: 'AI task scheduling and status sync',
