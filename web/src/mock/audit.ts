...
export const mockAuditRecords = [
  ...
  },
  {
    ...
    operator: 'ops-wang',
    operationType: 'UPDATE_ACL_RULE',
    resourceType: 'ACL_RULE',
    clusterId: 'prod-cn',
    target: '42',
    detail: '更新 ACL 规则 42：允许 user 只读访问 rmq-secure-topic',
  ...
  },
  {
    ...
    operator: 'system',
    operationType: 'RESEND_DLQ',
    resourceType: 'DLQ',
    clusterId: 'prod-hz',
    target: 'order-group',
    detail: '重发消费组 order-group 的死信消息',
    ipAddress: '10.0.1.2',
    result: 'FAILED' as const,
    errorMessage: 'DLQ resend timed out before completion',
  },
  {
    id: 7,
  ...
  },
  {
    ...
    clusterId: 'prod-cn',
    target: '43',
    detail: '更新 ACL 规则 43：移除 user: guest 对 rmq-admin-topic 的访问权限',
    ipAddress: '10.0.20.88',
    result: 'SUCCESS' as const,
  },
  {
  ...
  },
  {
    ...
    detail: '为集群 prod-bj 添加 Proxy 地址 10.0.1.1:8080',
    ipAddress: '10.0.1.1',
    result: 'SUCCESS' as const,
  },
  {
