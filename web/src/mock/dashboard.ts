...
export const systemAlerts = [
  {
    ...
    enTitle: 'High disk usage on rocketmq-prod-5',
    description: '磁盘使用率 86%，已自动切为只读模式',
    enDescription: 'Disk usage 86%; switched to read-only automatically.',
    time: '18:15',
    acknowledged: false,
  },
  {
    ...
    enTitle: 'rocketmq-prod-7 entered maintenance',
    description: '磁盘使用率 91%，已禁止读写，需人工介入处理',
    enDescription: 'Disk usage 91%; reads and writes disabled, manual intervention required.',
    time: '17:42',
    acknowledged: false,
  },
  {
    ...
    enTitle: 'rocketmq-prod-7 version is behind',
    description: '当前版本 5.1.4，集群版本 5.2.0，建议升级',
    enDescription: 'Current version 5.1.4, cluster version 5.2.0; upgrade recommended.',
    time: '16:30',
    acknowledged: true,
  },
];
