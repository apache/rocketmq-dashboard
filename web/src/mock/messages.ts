...
export const mockMessages: MessageRecord[] = [
  ...
  // ── notification-push (4 messages) ──
  {
    ...
    enBody: '{"notificationId":"N001","userId":10001,"type":"order_status","title":"Order shipped","content":"Your order 20240101001 has shipped, tracking SF1234567890","channel":"app"}',
  ...
  },
  {
    ...
    enBody: '{"notificationId":"N003","userId":10099,"type":"weekly_report","email":"user@example.com","subject":"Weekly spending report","templateId":"TPL_WEEKLY"}',
  ...
  },
  {
    ...
    enBody: '{"notificationId":"N004","userId":10201,"type":"promotion","title":"Limited-time offer","content":"The product SKU003 you follow is 200 CNY off - check it now","channel":"app"}',
