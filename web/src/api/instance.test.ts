...
const instance = { id: 'instance-1', name: 'orders', type: 'PROXY' as const, endpoint: 'proxy:8080', remark: '', topicCount: 0, consumerGroupCount: 0, createdAt: '2026-07-18T00:00:00Z', updatedAt: '2026-07-18T00:00:00Z' };
...
describe('instance API', () => {
  ...
  it('loads and returns persisted instance records', async () => {
    ...
    await expect(createInstance({ name: instance.name, type: instance.type, endpoint: instance.endpoint })).resolves.toEqual(instance);
