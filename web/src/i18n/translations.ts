...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'instance.aliyun': { zh: '阿里云', en: 'Alibaba Cloud' },
  ...
  'instance.cloudInstanceLabel': { zh: '云上实例', en: 'Cloud Instance' },
  'instance.cloudInstanceRequired': { zh: '请选择云上实例', en: 'Select a cloud instance' },
  'instance.cloudInstanceSelectPlaceholder': { zh: '选择云上实例', en: 'Select a cloud instance' },
  'instance.credentialLabel': { zh: '云凭据', en: 'Cloud Credential' },
  'instance.credentialPlaceholder': { zh: '选择已录入的 AK/SK 凭据', en: 'Select a stored AK/SK credential' },
  'instance.credentialRequired': { zh: '请选择云凭据', en: 'Select a cloud credential' },
  'instance.idDefaultFromCloud': { zh: '默认取云上实例 ID', en: 'Defaults to the cloud instance ID' },
  'instance.importAll': { zh: '一键导入', en: 'Import All' },
  'instance.importAllTooltip': { zh: '遍历该凭据下全部地域，将所有云上实例导入（幂等，已存在的自动跳过），备注自动取自云上实例', en: 'Walks every region under this credential and imports all cloud instances (idempotent; existing ones are skipped automatically). The remark is taken from the cloud instance.' },
  'instance.loading': { zh: '加载中…', en: 'Loading…' },
  'instance.regionCredFirstPlaceholder': { zh: '请先选择云凭据', en: 'Select a cloud credential first' },
  'instance.regionFirstPlaceholder': { zh: '请先选择地域', en: 'Select a region first' },
  'instance.regionLabel': { zh: '地域', en: 'Region' },
  'instance.regionRequired': { zh: '请选择地域', en: 'Select a region' },
  'instance.regionSelectPlaceholder': { zh: '选择地域', en: 'Select a region' },
