...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'consumerCompare.open': { zh: '配置对比', en: 'Compare Config' },
  'consumerCompare.title': {
    zh: '跨实例消费组配置对比',
    en: 'Cross-instance Consumer Group Comparison',
  },
  'consumerCompare.description': {
    zh: '对比两个实例中的消费组模式、消费类型、订阅数据类型、顺序类型与重试策略；在线客户端、堆积量、延迟和时间戳不参与对比。',
    en: 'Compare group modes, consume types, subscription data types, delivery order, and retry policy. Online clients, lag, delay, and timestamps are excluded.',
  },
  'consumerCompare.sourceInstance': { zh: '源实例', en: 'Source instance' },
  'consumerCompare.targetInstance': { zh: '目标实例', en: 'Target instance' },
  'consumerCompare.swap': { zh: '交换源实例和目标实例', en: 'Swap source and target' },
  'consumerCompare.compare': { zh: '开始对比', en: 'Compare' },
  'consumerCompare.needTwoInstances': {
    zh: '至少需要两个实例才能进行配置对比',
    en: 'At least two instances are required for comparison.',
  },
  'consumerCompare.selectDifferentInstances': {
    zh: '请选择两个不同的实例',
    en: 'Select two different instances.',
  },
  'consumerCompare.loadFailed': {
    zh: '消费组配置加载失败，请稍后重试',
    en: 'Failed to load consumer group configuration. Please try again.',
  },
  'consumerCompare.exported': {
    zh: '已导出 {count} 条对比结果',
    en: 'Exported {count} comparison rows.',
  },
  'consumerCompare.matches': { zh: '配置一致', en: 'Matching' },
  'consumerCompare.drifted': { zh: '配置漂移', en: 'Drifted' },
  'consumerCompare.onlySource': { zh: '仅源实例', en: 'Source only' },
  'consumerCompare.onlyTarget': { zh: '仅目标实例', en: 'Target only' },
  'consumerCompare.group': { zh: '消费组', en: 'Consumer Group' },
  'consumerCompare.status': { zh: '对比状态', en: 'Status' },
  'consumerCompare.differenceCount': { zh: '差异字段数', en: 'Differences' },
  'consumerCompare.field': { zh: '配置字段', en: 'Configuration field' },
  'consumerCompare.fieldNamespace': { zh: '命名空间', en: 'Namespace' },
  'consumerCompare.fieldSubscriptionMode': { zh: '订阅模式', en: 'Subscription mode' },
  'consumerCompare.fieldConsumeType': { zh: '消费类型', en: 'Consume type' },
  'consumerCompare.fieldSubscriptionDataType': {
    zh: '订阅数据类型',
    en: 'Subscription data type',
  },
  'consumerCompare.fieldDeliveryOrderType': { zh: '顺序类型', en: 'Delivery order type' },
  'consumerCompare.fieldRetryMaxTimes': { zh: '最大重试次数', en: 'Maximum retries' },
  'consumerCompare.search': { zh: '搜索 Group 名称', en: 'Search group name' },
  'consumerCompare.statusFilter': { zh: '对比状态筛选', en: 'Filter comparison status' },
  'consumerCompare.statusAll': { zh: '全部状态', en: 'All statuses' },
  'consumerCompare.statusMatch': { zh: '一致', en: 'Match' },
  'consumerCompare.statusDrift': { zh: '漂移', en: 'Drift' },
  'consumerCompare.statusOnlySource': { zh: '仅源实例', en: 'Source only' },
  'consumerCompare.statusOnlyTarget': { zh: '仅目标实例', en: 'Target only' },
  'consumerCompare.export': { zh: '导出结果', en: 'Export results' },
