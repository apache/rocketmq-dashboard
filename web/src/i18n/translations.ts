...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'instance.vendorApache': { zh: '开源版', en: 'Open Source' },
  'instance.vendorApacheDesc': { zh: '接入自建 Apache RocketMQ 开源集群，支持 Proxy / Direct 两种接入方式', en: 'Connect self-hosted Apache RocketMQ clusters; supports both Proxy and Direct access modes' },
  'instance.vendorAliyun': { zh: 'Aliyun 版', en: 'Aliyun' },
  'instance.vendorAliyunDesc': { zh: '选择已录入的云凭据与云上实例完成接入，接入点自动解析', en: 'Pick a stored cloud credential and a cloud instance to connect; the access point is resolved automatically' },
  'instance.vendorTencent': { zh: 'Tencent 版', en: 'Tencent' },
  'instance.vendorTencentDesc': { zh: '接入腾讯云 TDMQ RocketMQ 版实例，接入地址填写实例的接入点', en: 'Connect Tencent Cloud TDMQ RocketMQ instances; fill the access address with the instance endpoint' },
