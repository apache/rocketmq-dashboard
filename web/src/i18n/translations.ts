...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'topicPortfolio.open': { zh: '队列配置组合', en: 'Queue portfolio' },
  'topicPortfolio.title': { zh: 'Topic 队列配置组合', en: 'Topic queue configuration portfolio' },
  'topicPortfolio.description': {
    zh: '按类型、命名空间、读写队列数与权限聚合当前筛选范围内的全部 Topic，用于发现异常和容量碎片。',
    en: 'Group every topic in the current filter by type, namespace, queue counts, and permission to expose anomalies and capacity fragmentation.',
  },
  'topicPortfolio.hasAttention': {
    zh: '存在非均衡或受限的 Topic 配置',
    en: 'Some topic configurations are unbalanced or restricted.',
  },
  'topicPortfolio.allBalanced': {
    zh: '所有 Topic 队列配置均衡',
    en: 'All topic queue configurations are balanced.',
  },
  'topicPortfolio.BALANCED': { zh: '读写均衡', en: 'Balanced' },
  'topicPortfolio.ASYMMETRIC': { zh: '读写不对称', en: 'Asymmetric' },
  'topicPortfolio.READ_ONLY': { zh: '只读', en: 'Read only' },
  'topicPortfolio.WRITE_ONLY': { zh: '只写', en: 'Write only' },
  'topicPortfolio.NO_ACCESS': { zh: '无读写权限', en: 'No access' },
  'topicPortfolio.UNKNOWN_PERMISSION': { zh: '未知权限', en: 'Unknown permission' },
  'topicPortfolio.type': { zh: '类型', en: 'Type' },
  'topicPortfolio.namespace': { zh: '命名空间', en: 'Namespace' },
  'topicPortfolio.permission': { zh: '权限', en: 'Permission' },
  'topicPortfolio.writeReadQueues': { zh: '写/读队列', en: 'Write/read queues' },
  'topicPortfolio.topics': { zh: 'Topic 数', en: 'Topics' },
  'topicPortfolio.profiles': { zh: '配置组合', en: 'Profiles' },
  'topicPortfolio.share': { zh: 'Topic 占比', en: 'Topic share' },
  'topicPortfolio.capacity': { zh: '总写/读容量', en: 'Total write/read capacity' },
  'topicPortfolio.messages': { zh: '消息量', en: 'Messages' },
  'topicPortfolio.consumers': { zh: '消费组数', en: 'Consumer groups' },
  'topicPortfolio.samples': { zh: 'Topic 样例', en: 'Topic samples' },
  'topicPortfolio.balanced': { zh: '均衡 Topic', en: 'Balanced topics' },
  'topicPortfolio.attention': { zh: '需关注', en: 'Needs attention' },
  'topicPortfolio.search': {
    zh: '搜索类型、命名空间或 Topic',
    en: 'Search type, namespace, or topic',
  },
  'topicPortfolio.totalCapacity': {
    zh: '总写/读队列：{write}/{read}；最大组合占比：{share}%',
    en: 'Total write/read queues: {write}/{read}; largest profile: {share}%',
  },
  'topicPortfolio.empty': {
    zh: '没有符合条件的配置组合',
    en: 'No matching configuration profiles',
  },
  'topicPortfolio.loadFailed': {
    zh: 'Topic 队列配置组合加载失败',
    en: 'Failed to load the topic queue portfolio.',
  },
