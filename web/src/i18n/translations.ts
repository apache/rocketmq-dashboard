...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'metricsExplorer.title': { zh: 'Prometheus 指标', en: 'Prometheus Metrics' },
  'metricsExplorer.profile': { zh: '指标模板', en: 'Metric profile' },
  'metricsExplorer.range': { zh: '时间范围', en: 'Time range' },
  'metricsExplorer.refresh': { zh: '刷新全部面板', en: 'Refresh all panels' },
  'metricsExplorer.profileError': { zh: '指标模板加载失败', en: 'Failed to load metric profiles' },
  'metricsExplorer.noProfiles': { zh: '暂无指标模板', en: 'No metric profiles' },
  'metricsExplorer.noSamples': { zh: '暂无数据', en: 'No samples' },
  'metricsExplorer.histogram': { zh: '直方图', en: 'Histogram' },
  'metricsExplorer.histogramTooltip': { zh: '无标量样本，趋势由直方图观测值推导', en: 'No scalar samples; trend derived from histogram observations' },
  'metricsExplorer.hiddenSeries': { zh: '另有 {count} 条序列未显示（按最新值保留前 {maxSeries} 条）', en: '{count} more series hidden (showing top {maxSeries} by latest value)' },
  'metricsExplorer.defaultDataSource': { zh: '默认数据源', en: 'Default source' },
  'metricsExplorer.dataSource': { zh: '数据源', en: 'Data source' },
  'metricsExplorer.customTitle': { zh: '自定义查询', en: 'Custom query' },
  'metricsExplorer.customPlaceholder': { zh: '输入 PromQL，如 sum(rate(rocketmq_messages_in_total[1m])) by (cluster)', en: 'Enter PromQL, e.g. sum(rate(rocketmq_messages_in_total[1m])) by (cluster)' },
  'metricsExplorer.customRun': { zh: '查询', en: 'Run' },
  'metricsExplorer.customEmpty': { zh: '输入 PromQL 后点击查询', en: 'Enter a PromQL expression and run the query' },
  'metricsExplorer.authTitle': { zh: '数据源认证', en: 'Data source authentication' },
  'metricsExplorer.authDescription': { zh: '凭据仅用于当前数据源，离开该数据源后会被清除。', en: 'Credentials are used only for this source and cleared when you leave it.' },
  'metricsExplorer.username': { zh: '用户名', en: 'Username' },
  'metricsExplorer.password': { zh: '密码', en: 'Password' },
  'metricsExplorer.token': { zh: '令牌', en: 'Token' },
  'metricsExplorer.connect': { zh: '连接', en: 'Connect' },
  'metricsExplorer.cancel': { zh: '取消', en: 'Cancel' },
  'metricsExplorer.required': { zh: '此项为必填项', en: 'This field is required' },
  'metricsExplorer.queryErrorFallback': { zh: 'Prometheus 查询失败', en: 'Prometheus query failed' },
  // ─── BrokerCluster ───
};
