...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'cert.deleted': { zh: '证书「{name}」已删除', en: 'Certificate "{name}" deleted' },
  'cert.addCert': { zh: '新增证书', en: 'Add Certificate' },
  'cert.searchPlaceholder': { zh: '搜索 k8s ID 或集群', en: 'Search k8s ID or cluster' },
  ...
  'cert.action': { zh: '操作', en: 'Actions' },
  'cert.add': { zh: '添加', en: 'Add' },
  'cert.all': { zh: '全部', en: 'All' },
  'cert.cancel': { zh: '取消', en: 'Cancel' },
  'cert.certCreated': { zh: '证书「{name}」已添加', en: 'Certificate "{name}" added' },
  'cert.certPemHelp': { zh: '粘贴 PEM 格式证书，签发者、有效期与 SAN 将自动解析；留空时有效期按一年占位', en: 'Paste the PEM certificate; issuer, validity and SANs are parsed automatically. Leave blank to default to a one-year validity.' },
  'cert.certPemLabel': { zh: '证书内容（PEM）', en: 'Certificate Content (PEM)' },
  'cert.clusterNamePlaceholder': { zh: '例如：kubernetes（120.26.99.191:6443）', en: 'e.g. kubernetes (120.26.99.191:6443)' },
  'cert.clusterNameRequired': { zh: '请输入集群名称', en: 'Please enter the cluster name' },
  'cert.createCert': { zh: '新增证书', en: 'Add Certificate' },
  'cert.delete': { zh: '删除', en: 'Delete' },
  'cert.k8sIdPlaceholder': { zh: '例如：kubernetes-daily', en: 'e.g. kubernetes-daily' },
  'cert.k8sIdRequired': { zh: '请输入 k8s ID', en: 'Please enter the k8s ID' },
  'cert.keyPemHelp': { zh: '仅保存，不会在页面展示或返回', en: 'Stored only; never displayed or returned in the UI' },
  'cert.keyPemLabel': { zh: '私钥内容（PEM）', en: 'Private Key (PEM)' },
  'cert.localMetadataDescription': { zh: '创建、续期和删除操作尚不会应用到 Kubernetes 集群或 cert-manager。请在集群侧管理实际证书，直到 Kubernetes Provider 接入完成。', en: 'Create, renew and delete operations are not yet applied to the Kubernetes cluster or cert-manager. Manage the real certificates on the cluster side until the Kubernetes provider is wired in.' },
  'cert.localMetadataTitle': { zh: '当前证书记录仅保存为 Studio 本地元数据', en: 'Certificate records are only kept as Studio local metadata' },
  'cert.pageTitle': { zh: 'K8s 证书管理', en: 'K8s Certificate Management' },
  'cert.requestFailed': { zh: '请求失败，请稍后重试', en: 'Request failed, please retry later' },
  'cert.status': { zh: '状态', en: 'Status' },
  'cert.typeLabel': { zh: '类型', en: 'Type' },
