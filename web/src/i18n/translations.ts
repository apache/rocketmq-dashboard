...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'settings.credentialUsageProgress': {
    zh: '正在加载凭据：已读取 {loaded} / {total} 条',
    en: 'Loading credentials: {loaded} / {total} read',
  },
  'settings.credentialUsageLimit': {
    zh: '凭据数量超过单次分析的 10,000 条上限，请缩小数据范围后重试',
    en: 'This inventory exceeds the 10,000-credential analysis limit. Reduce the scope and retry.',
  },
