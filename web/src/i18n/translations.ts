...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'users.pageTitle': { zh: '用户管理', en: 'User Management' },
  'users.pageSubtitle': {
    zh: 'Studio 本地账号、会话与密码管理',
    en: 'Manage Studio-local accounts, sessions and passwords',
  },
  'users.notAdminTitle': { zh: '当前账号不是管理员', en: 'Current account is not an admin' },
  'users.notAdminDesc': {
    zh: '你可以修改自己的密码；用户列表和账号状态仅对管理员开放。',
    en: 'You can change your own password; the user list and account states are only available to admins.',
  },
  'users.myAccount': { zh: '我的账号', en: 'My Account' },
  'users.changeMyPassword': { zh: '修改我的密码', en: 'Change My Password' },
  'users.newUser': { zh: '新建用户', en: 'New User' },
  'users.export': { zh: '导出', en: 'Export' },
  'users.loadFailed': { zh: '加载用户列表失败', en: 'Failed to load the user list' },
  'users.created': { zh: '用户已创建', en: 'User created' },
  'users.createFailed': { zh: '创建用户失败', en: 'Failed to create the user' },
  'users.enabledToast': { zh: '用户已启用', en: 'User enabled' },
  'users.disabledToast': {
    zh: '用户已禁用，全部会话已注销',
    en: 'User disabled; all sessions were signed out',
  },
  'users.updateFailed': { zh: '更新用户状态失败', en: 'Failed to update the user status' },
  'users.passwordChangedToast': {
    zh: '密码已修改，请使用新密码重新登录',
    en: 'Password changed; sign in again with the new password',
  },
  'users.passwordResetToast': {
    zh: '密码已重置，用户的现有会话已注销',
    en: 'Password reset; the user\'s existing sessions were signed out',
  },
  'users.passwordChangeFailed': { zh: '修改密码失败', en: 'Failed to change the password' },
  'users.exportedToast': { zh: '已导出 {count} 个用户', en: 'Exported {count} users' },
  'users.exportFailed': {
    zh: '导出用户列表失败，请稍后重试',
    en: 'Failed to export the user list, please retry later',
  },
  'users.username': { zh: '用户名', en: 'Username' },
  'users.userId': { zh: '用户 ID', en: 'User ID' },
  'users.role': { zh: '权限', en: 'Role' },
  'users.roleAdmin': { zh: '管理员', en: 'Admin' },
  'users.roleReader': { zh: '普通用户', en: 'User' },
  'users.enabled': { zh: '已启用', en: 'Enabled' },
  'users.disabled': { zh: '已禁用', en: 'Disabled' },
  'users.switchEnable': { zh: '启用', en: 'Enable' },
  'users.switchDisable': { zh: '禁用', en: 'Disable' },
  'users.createdAt': { zh: '创建时间', en: 'Created At' },
  'users.changePwdShort': { zh: '改密', en: 'Change Password' },
  'users.searchPlaceholder': { zh: '搜索用户名', en: 'Search username' },
  'users.filterByRole': { zh: '按权限筛选', en: 'Filter by role' },
  'users.allRoles': { zh: '全部权限', en: 'All Roles' },
  'users.filterByStatus': { zh: '按状态筛选', en: 'Filter by status' },
  'users.allStatuses': { zh: '全部状态', en: 'All Statuses' },
  'users.unit': { zh: '个用户', en: 'users' },
  'users.createTitle': { zh: '新建 Studio 用户', en: 'New Studio User' },
  'users.initialPassword': { zh: '初始密码', en: 'Initial Password' },
  'users.passwordMin': {
    zh: '密码至少 8 位',
    en: 'Password must be at least 8 characters',
  },
  'users.adminRoleLabel': { zh: '管理员权限', en: 'Admin Access' },
  'users.resetTitle': { zh: '重置 {name} 的密码', en: 'Reset password for {name}' },
  'users.currentPassword': { zh: '当前密码', en: 'Current Password' },
