...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // ─── Topic send-message flow ───
  'topic.bodyFormatEmpty': { zh: '空 Body', en: 'Empty Body' },
  'topic.bodyFormatJsonScalar': { zh: 'JSON 标量', en: 'JSON Scalar' },
  'topic.bodyFormatPlainText': { zh: '文本', en: 'Text' },
  'topic.bodyTypeLabel': { zh: 'Body 类型', en: 'Body Type' },
  'topic.customProperties': { zh: '自定义属性', en: 'Custom Properties' },
  'topic.noPayloadIssues': { zh: '未发现阻止发送的问题', en: 'No blocking issues found' },
  'topic.none': { zh: '无', en: 'None' },
  'topic.payloadError': { zh: '阻止发送', en: 'Blocked' },
  'topic.payloadReady': { zh: '可以发送', en: 'Ready to send' },
  'topic.payloadWarning': { zh: '建议检查', en: 'Review suggested' },
  'topic.preflight': { zh: '发送前预检', en: 'Pre-send Check' },
  'topic.preflightBlocked': { zh: '发现 {count} 个阻止发送的问题。', en: 'Found {count} blocking issues.' },
  'topic.preflightFailed': { zh: '发送前预检未通过：{titles}', en: 'Pre-send check failed: {titles}' },
  'topic.preflightReadyDesc': { zh: '将按下方摘要发送到 RocketMQ，发送前可继续调整 Body、Tag、Key 和自定义属性。', en: 'The message will be sent to RocketMQ as summarized below; you can still adjust Body, Tag, Key and custom properties before sending.' },
  'topic.propertySize': { zh: '属性大小', en: 'Property size' },
  'topic.propsFormMode': { zh: '逐条录入', en: 'Enter one by one' },
  'topic.propsTextHint': { zh: '支持 key=value，每行填写一个属性；属性值可以包含逗号', en: 'Supports key=value, one property per line; values may contain commas' },
  'topic.propsTextMode': { zh: '批量粘贴', en: 'Paste in bulk' },
  'topic.sendFailed': { zh: '消息发送失败，请稍后重试', en: 'Message send failed, please retry later' },
  'topic.severityError': { zh: '阻止', en: 'Block' },
  'topic.severityInfo': { zh: '提示', en: 'Info' },
  'topic.severityWarning': { zh: '关注', en: 'Watch' },
  // ─── BrokerCluster ───
};
