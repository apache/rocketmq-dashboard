...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // ─── Consumer group detail overview & health ───
  'consumer.allConsistent': { zh: '全部 {count} 个订阅配置一致', en: 'All {count} subscription configurations are consistent' },
  'consumer.allQueuesComputable': { zh: 'Queue 堆积均可计算', en: 'All Queue lags are computable' },
  'consumer.clientsCard': { zh: '客户端', en: 'Clients' },
  'consumer.clusterId': { zh: '所属集群', en: 'Cluster' },
  'consumer.consistencyCheck': { zh: '订阅一致性检查', en: 'Subscription Consistency Check' },
  'consumer.consistencyChecking': { zh: '正在检查订阅一致性', en: 'Checking subscription consistency' },
  'consumer.consistencyFailed': { zh: '订阅一致性检查失败，当前保留上次检查结果', en: 'Subscription consistency check failed; the last result is kept' },
  'consumer.detailConsumeType': { zh: '消费类型', en: 'Consume Type' },
  'consumer.detailTitle': { zh: 'Group 详情', en: 'Group Details' },
  'consumer.healthAutoRefreshNote': { zh: '诊断结果随详情弹窗每 2 秒自动刷新。', en: 'Diagnostics auto-refresh with the detail modal every 2 seconds.' },
  'consumer.healthIssueDetail': { zh: '说明', en: 'Description' },
  'consumer.healthIssueLevel': { zh: '级别', en: 'Level' },
  'consumer.healthIssueTitle': { zh: '诊断项', en: 'Diagnostic Item' },
  'consumer.healthScore': { zh: '健康分', en: 'Health Score' },
  'consumer.healthSeverityInfo': { zh: '提示', en: 'Info' },
  'consumer.healthSeverityRisk': { zh: '风险', en: 'Risk' },
  'consumer.healthSeverityWatch': { zh: '关注', en: 'Watch' },
  'consumer.healthSummaryText': { zh: '汇总订阅、队列进度和在线客户端，定位消费风险。', en: 'Aggregates subscriptions, queue progress and online clients to locate consumption risks.' },
  'consumer.healthUsingAvailableData': { zh: '订阅一致性检查失败，诊断仍使用当前可用的进度和客户端数据。', en: 'Subscription consistency check failed; diagnostics still use the currently available progress and client data.' },
  'consumer.heartbeatOk': { zh: '心跳状态正常', en: 'Heartbeats are healthy' },
  'consumer.inconsistentFound': { zh: '发现 {count} 个订阅配置不一致', en: 'Found {count} inconsistent subscription configurations' },
  'consumer.knownLag': { zh: '已知堆积', en: 'Known Lag' },
  'consumer.noHealthRisks': { zh: '未发现消费组健康风险', en: 'No consumer group health risks found' },
  'consumer.noSubscriptions': { zh: '暂无订阅关系可检查', en: 'No subscriptions to check' },
  'consumer.onlineInstances': { zh: '在线实例', en: 'Online Instances' },
  'consumer.onlyInconsistent': { zh: '仅看不一致', en: 'Show only inconsistent' },
  'consumer.queueCoverage': { zh: 'Queue 覆盖', en: 'Queue Coverage' },
  'consumer.recheckConsistency': { zh: '重新检查', en: 'Re-check' },
  'consumer.recommendations': { zh: '处理建议', en: 'Recommendations' },
  'consumer.rediagnose': { zh: '重新诊断', en: 'Re-diagnose' },
  'consumer.reportedLagPrefix': { zh: '报告堆积：', en: 'Reported lag: ' },
  'consumer.staleClients': { zh: '{count} 个心跳过期', en: '{count} stale heartbeats' },
  'consumer.subscribedTopics': { zh: '订阅 Topic', en: 'Subscribed Topic' },
  'consumer.subscribedTopicsCount': { zh: '订阅 Topic 数', en: 'Subscribed Topics' },
  'consumer.tabHealth': { zh: '健康诊断', en: 'Health Diagnostics' },
  'consumer.tabOverview': { zh: '概览', en: 'Overview' },
  'consumer.times': { zh: ' 次', en: ' times' },
  'consumer.totalLagShort': { zh: '总堆积', en: 'Total Lag' },
  'consumer.unknownCount': { zh: '{count} 个订阅配置状态未知', en: '{count} subscription configurations have unknown status' },
  'consumer.unknownQueues': { zh: '{count} 个 Queue 堆积不可用', en: '{count} Queues have unavailable lag' },
  // ─── BrokerCluster ───
};
