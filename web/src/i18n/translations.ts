...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'aclCompare.open': { zh: '策略对比', en: 'Compare Policies' },
  'aclCompare.title': { zh: '跨实例 ACL 策略对比', en: 'Cross-instance ACL Policy Comparison' },
  'aclCompare.description': {
    zh: '对比两个实例中的 ACL 用户权限与规则语义，识别策略漂移和单侧缺失项。',
    en: 'Compare ACL user permissions and rule semantics across two instances to identify drift and missing policies.',
  },
  'aclCompare.secretNotice': {
    zh: '凭据密钥不会被读取、比较或导出。',
    en: 'Credential secrets are never read, compared, or exported.',
  },
  'aclCompare.sourceInstance': { zh: '源实例', en: 'Source instance' },
  'aclCompare.targetInstance': { zh: '目标实例', en: 'Target instance' },
  'aclCompare.swap': { zh: '交换源实例和目标实例', en: 'Swap source and target' },
  'aclCompare.compare': { zh: '开始对比', en: 'Compare' },
  'aclCompare.needTwoInstances': {
    zh: '至少需要两个实例才能进行策略对比',
    en: 'At least two instances are required for policy comparison.',
  },
  'aclCompare.selectDifferentInstances': {
    zh: '请选择两个不同的实例',
    en: 'Select two different instances.',
  },
  'aclCompare.loadFailed': {
    zh: 'ACL 策略加载失败，请稍后重试',
    en: 'Failed to load ACL policies. Please try again.',
  },
  'aclCompare.exported': {
    zh: '已导出 {count} 条策略对比结果',
    en: 'Exported {count} policy comparison rows.',
  },
  'aclCompare.users': { zh: '用户', en: 'Users' },
  'aclCompare.rules': { zh: '规则', en: 'Rules' },
  'aclCompare.matches': { zh: '一致', en: 'Matching' },
  'aclCompare.drifted': { zh: '漂移', en: 'Drifted' },
  'aclCompare.missing': { zh: '单侧缺失', en: 'Missing on one side' },
  'aclCompare.kind': { zh: '策略类型', en: 'Policy kind' },
  'aclCompare.identity': { zh: '策略身份', en: 'Policy identity' },
  'aclCompare.status': { zh: '对比状态', en: 'Status' },
  'aclCompare.differenceCount': { zh: '差异数', en: 'Differences' },
  'aclCompare.kindAll': { zh: '全部类型', en: 'All kinds' },
  'aclCompare.kindUser': { zh: '用户', en: 'User' },
  'aclCompare.kindRule': { zh: '规则', en: 'Rule' },
  'aclCompare.statusAll': { zh: '全部状态', en: 'All statuses' },
  'aclCompare.statusMatch': { zh: '一致', en: 'Match' },
  'aclCompare.statusDrift': { zh: '漂移', en: 'Drift' },
  'aclCompare.statusOnlySource': { zh: '仅源实例', en: 'Source only' },
  'aclCompare.statusOnlyTarget': { zh: '仅目标实例', en: 'Target only' },
  'aclCompare.search': { zh: '搜索用户或规则身份', en: 'Search user or rule identity' },
  'aclCompare.kindFilter': { zh: '策略类型筛选', en: 'Filter policy kind' },
  'aclCompare.statusFilter': { zh: '对比状态筛选', en: 'Filter status' },
  'aclCompare.field': { zh: '策略字段', en: 'Policy field' },
  'aclCompare.fieldAdmin': { zh: '管理员权限', en: 'Administrator' },
  'aclCompare.fieldClusters': { zh: '关联集群', en: 'Associated clusters' },
  'aclCompare.fieldRead': { zh: '读取权限', en: 'Read permission' },
  'aclCompare.fieldWrite': { zh: '写入权限', en: 'Write permission' },
  'aclCompare.fieldActions': { zh: '授权动作', en: 'Actions' },
  'aclCompare.fieldDecision': { zh: '授权决策', en: 'Decision' },
  'aclCompare.fieldVersion': { zh: 'ACL 版本', en: 'ACL version' },
  'aclCompare.export': { zh: '导出结果', en: 'Export results' },
