...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'common.copied': { zh: '已复制到剪贴板', en: 'Copied to clipboard' },
  'common.copyFailed': { zh: '复制失败，请手动复制', en: 'Copy failed. Please copy manually.' },
  ...
  'message.copyTrace': { zh: '复制轨迹', en: 'Copy Trace' },
  'message.traceStepTime': { zh: '时间', en: 'Time' },
  'message.traceStepStatus': { zh: '状态', en: 'Status' },
  'message.traceStepCost': { zh: '耗时', en: 'Cost' },
  'message.traceStepDetail': { zh: '详情', en: 'Detail' },
