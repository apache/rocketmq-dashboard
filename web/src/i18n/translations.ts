...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // ─── Consumer group create & import ───
  'consumer.close': { zh: '关闭', en: 'Close' },
  'consumer.confirmCreate': { zh: '确认创建', en: 'Confirm Create' },
  'consumer.confirmCreateContent': { zh: '将创建消费组 "{name}"', en: 'A consumer group "{name}" will be created' },
  'consumer.consumeBroadcasting': { zh: '广播消费', en: 'Broadcasting' },
  'consumer.consumeClustering': { zh: '集群消费', en: 'Clustering' },
  'consumer.consumeTypeLabel': { zh: '消费类型', en: 'Consume Type' },
  'consumer.createButton': { zh: '创建', en: 'Create' },
  'consumer.createGroupLabel': { zh: '创建 Group', en: 'Create Group' },
  'consumer.createdToast': { zh: '消费组 {name} 创建成功', en: 'Consumer group {name} created successfully' },
  'consumer.csvNotImportable': { zh: 'CSV 无法导入', en: 'CSV cannot be imported' },
  'consumer.csvParseFailed': { zh: 'CSV 解析失败', en: 'Failed to parse CSV' },
  'consumer.dataTypeDelay': { zh: '延迟消息', en: 'Delay Message' },
  'consumer.dataTypeNormal': { zh: '普通消息', en: 'Normal Message' },
  'consumer.dataTypeOrder': { zh: '顺序消息', en: 'Order Message' },
  'consumer.dataTypePlaceholder': { zh: '选择消息类型', en: 'Select a message type' },
  'consumer.dataTypeTransaction': { zh: '事务消息', en: 'Transaction Message' },
  'consumer.description': { zh: '说明', en: 'Description' },
  'consumer.importColumnsNote': { zh: '仅导入可创建字段；CSV 中的 Namespace、Cluster ID 和运行状态列会被忽略。', en: 'Only creatable fields are imported; the Namespace, Cluster ID and runtime status columns in the CSV are ignored.' },
  'consumer.importFailed': { zh: '{count} 个 Group 导入失败', en: 'Failed to import {count} Groups' },
  'consumer.importFailedShort': { zh: '失败', en: 'Failed' },
  'consumer.importInvalid': { zh: '无效', en: 'Invalid' },
  'consumer.importPartialFailed': { zh: '已导入 {imported} 个 Group，{failed} 个失败', en: '{imported} Groups imported, {failed} failed' },
  'consumer.importPending': { zh: '待导入', en: 'Pending' },
  'consumer.importPlanNotice': { zh: '检测到 {count} 个 Group，将通过后端批量导入', en: '{count} Groups detected; they will be imported in batch through the backend' },
  'consumer.importSuccess': { zh: '成功', en: 'Success' },
  'consumer.importTitle': { zh: '导入 Group', en: 'Import Groups' },
  'consumer.importTitleWithFile': { zh: '导入 Group：{file}', en: 'Import Groups: {file}' },
  'consumer.importWithInvalid': { zh: '已导入 {imported} 个 Group，{invalid} 行无效已跳过', en: '{imported} Groups imported; {invalid} invalid rows skipped' },
  'consumer.imported': { zh: '已导入 {count} 个 Group', en: '{count} Groups imported' },
  'consumer.invalidRowsNotice': { zh: '检测到 {count} 行无效，将跳过这些行', en: '{count} invalid rows detected; they will be skipped' },
  'consumer.lineNumber': { zh: '行号', en: 'Line' },
  'consumer.nameMaxLength': { zh: '名称不能超过 {count} 个字符', en: 'Name must not exceed {count} characters' },
  'consumer.namePattern': { zh: '仅支持字母、数字、下划线、短横线、% 和 |', en: 'Only letters, digits, underscores, hyphens, % and | are supported' },
  'consumer.namePlaceholder': { zh: '例：cg-order-notify', en: 'e.g. cg-order-notify' },
  'consumer.nameRequired': { zh: '请输入 Group 名称', en: 'Enter the Group name' },
  'consumer.orderTypeGlobal': { zh: '全局顺序', en: 'Global Order' },
  'consumer.orderTypeLabel': { zh: '顺序类型', en: 'Order Type' },
  'consumer.orderTypePartition': { zh: '分区顺序', en: 'Partition Order' },
  'consumer.retryFailedItems': { zh: '重试失败项', en: 'Retry Failed Items' },
  'consumer.rowCreateFailed': { zh: '创建失败', en: 'Create failed' },
  'consumer.rowCreated': { zh: '已创建', en: 'Created' },
  'consumer.selectInstanceFirst': { zh: '请先选择实例', en: 'Select an instance first' },
  'consumer.startImport': { zh: '开始导入', en: 'Start Import' },
  // ─── BrokerCluster ───
};
