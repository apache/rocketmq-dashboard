...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'proxy.topologyAction': { zh: '连通性拓扑', en: 'Connectivity topology' },
  'proxy.topologyTitle': { zh: 'Proxy 连通性拓扑清单', en: 'Proxy connectivity topology' },
  'proxy.topologyDescription': {
    zh: '关联已注册地址与实时探测结果，展示 gRPC、Remoting 连通性、延迟及主机分布。',
    en: 'Correlates registered addresses with live probes to show gRPC and Remoting reachability, latency, and host distribution.',
  },
  'proxy.topologyExport': { zh: '导出当前结果', en: 'Export current results' },
  'proxy.topologyRegistered': { zh: '已注册节点', en: 'Registered nodes' },
  'proxy.topologyProbed': { zh: '已探测节点', en: 'Probed nodes' },
  'proxy.topologyFullyReachable': { zh: '完全可达', en: 'Fully reachable' },
  'proxy.topologyAttention': { zh: '需关注', en: 'Needs attention' },
  'proxy.topologyGapWarning': {
    zh: '发现 {count} 个注册与探测结果不一致的节点，请检查地址配置与服务发现状态。',
    en: 'Found {count} nodes that differ between registration and probe results. Check address configuration and service discovery.',
  },
  'proxy.topologyHost': { zh: '主机', en: 'Host' },
  'proxy.topologyGrpc': { zh: 'gRPC 端口 / 连通性', en: 'gRPC port / reachability' },
  'proxy.topologyRemoting': {
    zh: 'Remoting 端口 / 连通性',
    en: 'Remoting port / reachability',
  },
  'proxy.topologyLatency': { zh: '探测延迟', en: 'Probe latency' },
  'proxy.topologyReachable': { zh: '可达', en: 'Reachable' },
  'proxy.topologyUnreachable': { zh: '不可达', en: 'Unreachable' },
  'proxy.topologyUp': { zh: '完全可达', en: 'Up' },
  'proxy.topologyPartial': { zh: '部分可达', en: 'Partial' },
  'proxy.topologyDown': { zh: '不可达', en: 'Down' },
  'proxy.topologyRegisteredOnly': { zh: '仅注册地址', en: 'Registered only' },
  'proxy.topologyDiscoveredOnly': { zh: '仅探测发现', en: 'Discovered only' },
  'proxy.topologySearch': { zh: '搜索地址、主机或状态', en: 'Search address, host, or status' },
  'proxy.topologyAllStatuses': { zh: '全部探测状态', en: 'All probe statuses' },
  'proxy.topologyGapOnly': { zh: '仅看注册差异', en: 'Registration gaps only' },
  'proxy.topologyFiltered': {
    zh: '显示 {visible} / {total} 个节点',
    en: 'Showing {visible} of {total} nodes',
  },
  'proxy.topologyNodesTab': { zh: '节点明细 ({count})', en: 'Node details ({count})' },
  'proxy.topologyHostsTab': { zh: '主机分布 ({count})', en: 'Host distribution ({count})' },
  'proxy.topologyNodeCount': { zh: '节点数', en: 'Nodes' },
  'proxy.topologyReachableNodes': { zh: '完全可达节点', en: 'Fully reachable nodes' },
  'proxy.topologyPorts': { zh: '探测端口', en: 'Probe ports' },
