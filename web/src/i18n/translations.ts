...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'instance.headerDesc': { zh: '接入并管理 RocketMQ 实例（开源自建 / 阿里云 / 腾讯云），当前显示 {count} 个实例', en: 'Connect and manage RocketMQ instances (self-hosted / Alibaba Cloud / Tencent Cloud) — showing {count} instance(s)' },
  'instance.typeCloud': { zh: '云服务', en: 'Cloud' },
  'instance.typeDirect': { zh: 'Direct 模式', en: 'Direct Mode' },
  'instance.typeProxyCluster': { zh: 'Proxy Cluster 模式', en: 'Proxy Cluster Mode' },
  'instance.typeProxyLocal': { zh: 'Proxy Local 模式', en: 'Proxy Local Mode' },
