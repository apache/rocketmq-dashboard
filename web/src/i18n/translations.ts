...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'settings.connectivityAction': { zh: '批量连通性', en: 'Batch connectivity' },
  'settings.connectivityTitle': {
    zh: '数据源批量连通性检查',
    en: 'Data source connectivity batch',
  },
  'settings.connectivityDescription': {
    zh: '使用现有测试接口，以最多 3 个并发检查当前筛选范围内无需密钥的数据源。',
    en: 'Uses the existing test endpoint with at most three concurrent checks for sources that do not require credentials.',
  },
  'settings.connectivityScope': {
    zh: '列表筛选：搜索={search}，类型={type}。认证型数据源不会发送空密钥。',
    en: 'List filters: search={search}, type={type}. Authenticated sources are never sent with empty credentials.',
  },
  'settings.connectivityRun': { zh: '开始检查', en: 'Run checks' },
  'settings.connectivityRerun': { zh: '重新检查', en: 'Run again' },
  'settings.connectivityBatchFailed': {
    zh: '数据源批量连通性检查失败',
    en: 'Data source connectivity batch failed',
  },
  'settings.connectivityEmpty': {
    zh: '尚未运行检查。带认证的数据源将明确跳过，需要在编辑器内输入凭据后单独测试。',
    en: 'Checks have not run. Authenticated sources are skipped and must be tested individually with credentials in the editor.',
  },
  'settings.connectivityTotal': { zh: '数据源总数', en: 'Data sources' },
  'settings.connectivitySuccess': { zh: '连通', en: 'Reachable' },
  'settings.connectivityFailed': { zh: '失败', en: 'Failed' },
  'settings.connectivitySkipped': { zh: '跳过认证项', en: 'Skipped auth' },
  'settings.connectivitySkippedHint': {
    zh: '{count} 个数据源需要运行时凭据，已安全跳过。',
    en: '{count} sources require runtime credentials and were safely skipped.',
  },
  'settings.connectivityLatency': { zh: '耗时', en: 'Latency' },
  'settings.connectivityInstances': { zh: '适用实例数', en: 'Instances' },
  'settings.connectivityMessage': { zh: '结果信息', en: 'Result message' },
  'settings.connectivitySearch': {
    zh: '搜索名称、URL 或结果',
    en: 'Search name, URL, or result',
  },
  'settings.connectivityAllStatuses': { zh: '全部检查状态', en: 'All check statuses' },
  'settings.connectivityLatencySummary': {
    zh: '平均 {average} ms，最慢 {slowest} ms',
    en: 'Average {average} ms, slowest {slowest} ms',
  },
