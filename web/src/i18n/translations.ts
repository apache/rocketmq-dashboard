...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'cluster.topologySummary': { zh: '拓扑健康汇总', en: 'Topology Health Summary' },
  'cluster.topologyHealthyClusters': { zh: '健康集群', en: 'Healthy Clusters' },
  'cluster.topologyBrokerHealth': { zh: 'Broker 健康', en: 'Broker Health' },
  'cluster.topologyNameServerHealth': { zh: 'NameServer 健康', en: 'NameServer Health' },
  'cluster.topologyProxyHealth': { zh: 'Proxy 健康', en: 'Proxy Health' },
  'cluster.topologyMaxDisk': { zh: '最高磁盘使用率', en: 'Max Disk Usage' },
  'cluster.topologyVersionDrift': { zh: '版本不一致集群', en: 'Version Drift Clusters' },
  'cluster.topologySummaryHealthy': {
    zh: '当前拓扑未发现健康风险',
    en: 'No topology health risks were detected',
  },
  'cluster.topologySummaryWarning': {
    zh: '发现 {n} 个拓扑健康告警',
    en: '{n} topology health warning(s) detected',
  },
  'cluster.topologySummaryCritical': {
    zh: '发现 {n} 个严重拓扑健康问题',
    en: '{n} critical topology health issue(s) detected',
  },
  'cluster.topologyNoIssues': { zh: '暂无拓扑健康问题', en: 'No topology health issues' },
  'cluster.topologySummaryUnavailable': {
    zh: '拓扑健康汇总暂不可用',
    en: 'Topology health summary is unavailable',
  },
  'cluster.topologyIssueSeverity': { zh: '级别', en: 'Severity' },
  'cluster.topologyIssueCritical': { zh: '严重', en: 'Critical' },
  'cluster.topologyIssueWarning': { zh: '告警', en: 'Warning' },
  'cluster.topologyIssueComponent': { zh: '组件', en: 'Component' },
  'cluster.topologyIssueNode': { zh: '节点', en: 'Node' },
