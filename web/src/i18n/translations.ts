...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'ai.thinkingLabel': {
    zh: '思维链：Prompt 增强改写',
    en: 'Chain of thought: enhanced Prompt rewrite',
  },
  'ai.thinking': { zh: '正在思考…', en: 'Thinking…' },
  'ai.action.clusterStatus': { zh: '查看集群状态', en: 'Check cluster status' },
  'ai.action.topicBacklogTop': { zh: 'Topic 堆积 Top10', en: 'Topic backlog Top 10' },
  'ai.action.diagnoseLag': { zh: '诊断消费延迟', en: 'Diagnose consume lag' },
  'ai.action.createTopic': { zh: '创建 Topic', en: 'Create a Topic' },
  'ai.action.traceMessage': { zh: '消息轨迹查询', en: 'Trace a message' },
  'ai.action.scaleEvaluation': { zh: '扩缩容评估', en: 'Evaluate scaling' },
  'ai.toolInputInvalid': {
    zh: '工具参数必须是有效的 JSON 对象',
    en: 'Tool parameters must be a valid JSON object',
  },
  'ai.toolExecuted': { zh: '工具执行成功', en: 'Tool executed successfully' },
  'ai.toolExecutionFailed': { zh: '工具执行失败', en: 'Tool execution failed' },
  'ai.notEnabled': { zh: 'AI 助手未启用', en: 'AI assistant is not enabled' },
  'ai.goConfigure': { zh: '去配置', en: 'Go to Settings' },
  'ai.settingsHintPrefix': {
    zh: '模型服务与执行引擎可在',
    en: 'Model services and the agent engine can be configured in',
  },
  'ai.settingsHintLink': { zh: '设置 → AI 助手', en: 'Settings → AI Assistant' },
  'ai.settingsHintSuffix': { zh: ' 中配置', en: '' },
  'ai.loadingModels': { zh: '加载模型中...', en: 'Loading models...' },
  'ai.selectModel': { zh: '选择模型', en: 'Select model' },
  'ai.engine': { zh: '执行引擎', en: 'Agent engine' },
  'ai.readySuffix': { zh: ' 已就绪', en: ' ready' },
  'ai.notReadySuffix': { zh: ' 未就绪', en: ' not ready' },
  'ai.inputPlaceholder': {
    zh: '输入你的问题或指令，例如：查看集群状态、创建 Topic、诊断消费延迟...',
    en: 'Ask a question or give an instruction, e.g. check cluster status, create a Topic, diagnose consume lag...',
  },
  'ai.tools': { zh: '工具', en: 'Tools' },
  'ai.enhanceTitle': { zh: '发送前增强 Prompt', en: 'Enhance prompt before sending' },
  'ai.enhance': { zh: 'Prompt 增强', en: 'Prompt Enhance' },
  'ai.stopGenerating': { zh: '停止生成', en: 'Stop Generating' },
  'ai.toolsModalTitle': { zh: 'AI 工具', en: 'AI Tools' },
  ...
  'ai.toolParamsJson': { zh: '工具参数 JSON', en: 'Tool parameters JSON' },
  'ai.executionResult': { zh: '执行结果', en: 'Execution result' },
  // ─── BrokerCluster ───
};
