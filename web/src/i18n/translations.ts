...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'common.totalUsers': { zh: '共 {count} 个用户', en: 'Total {count} users' },
  'common.totalGroups': { zh: '共 {count} 个 Group', en: 'Total {count} groups' },
  'common.totalMessages': { zh: '共 {count} 条消息', en: 'Total {count} messages' },
  ...
  'common.totalRules': { zh: '共 {count} 条规则', en: 'Total {count} rules' },
