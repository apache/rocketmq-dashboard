...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'alertAssets.catalogInsights': { zh: '规则资产覆盖洞察', en: 'Rule Asset Coverage Insights' },
  'alertAssets.assetCount': { zh: '资产数', en: 'Assets' },
  'alertAssets.totalRules': { zh: '总规则数', en: 'Total Rules' },
  'alertAssets.groupCount': { zh: '{n} 个规则组', en: '{n} groups' },
  'alertAssets.visibleAssets': { zh: '当前显示 {n} 个', en: '{n} visible' },
  'alertAssets.domain': { zh: '覆盖域', en: 'Domain' },
  'alertAssets.domainCoverage': { zh: '核心域覆盖', en: 'Core Domain Coverage' },
  'alertAssets.coverageShare': { zh: '规则占比', en: 'Rule Share' },
  'alertAssets.criticalAssets': { zh: 'Critical 资产', en: 'Critical Assets' },
  'alertAssets.groups': { zh: '规则组', en: 'Groups' },
  'alertAssets.readinessScore': { zh: '就绪分', en: 'Readiness Score' },
  'alertAssets.findings': { zh: '覆盖发现', en: 'Findings' },
  'alertAssets.exportCatalog': { zh: '导出目录', en: 'Export catalog' },
  'alertAssets.catalogExported': { zh: '规则资产目录已导出', en: 'Rule asset catalog exported' },
  'alertAssets.level.healthy': { zh: '健康', en: 'Healthy' },
  'alertAssets.level.notice': { zh: '关注', en: 'Notice' },
  'alertAssets.level.warning': { zh: '告警', en: 'Warning' },
  'alertAssets.level.critical': { zh: '严重', en: 'Critical' },
  'alertAssets.domain.broker': { zh: 'Broker', en: 'Broker' },
  'alertAssets.domain.consumer': { zh: 'Consumer', en: 'Consumer' },
  'alertAssets.domain.producer': { zh: 'Producer', en: 'Producer' },
  'alertAssets.domain.topic': { zh: 'Topic', en: 'Topic' },
  'alertAssets.domain.proxy': { zh: 'Proxy', en: 'Proxy' },
  'alertAssets.domain.client': { zh: 'Client', en: 'Client' },
  'alertAssets.domain.dlq': { zh: 'DLQ', en: 'DLQ' },
  'alertAssets.domain.error': { zh: 'Error', en: 'Error' },
  'alertAssets.domain.runtime': { zh: 'Runtime', en: 'Runtime' },
  'alertAssets.domain.unknown': { zh: 'Unknown', en: 'Unknown' },
  'alertAssets.issueNoAssets': { zh: '没有可用的规则资产', en: 'No rule assets are available' },
  'alertAssets.issueDuplicateName': {
    zh: '资产名称重复：{asset}',
    en: 'Duplicate asset name: {asset}',
  },
  'alertAssets.issueEmptyAsset': {
    zh: '{asset} 没有规则',
    en: '{asset} has no rules',
  },
  'alertAssets.issueMissingSeverity': {
    zh: '{asset} 没有级别标签',
    en: '{asset} has no severity label',
  },
  'alertAssets.issueDomainUncovered': {
    zh: '{domain} 没有内置资产覆盖',
    en: '{domain} has no bundled asset coverage',
  },
  'alertAssets.issueDomainWithoutCritical': {
    zh: '{domain} 没有 Critical 资产',
    en: '{domain} has no critical asset',
  },
  'alertAssets.issueUnknown': { zh: '发现未知资产问题', en: 'Unknown asset issue detected' },
