...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'cluster.registryReconcileAction': { zh: '注册一致性', en: 'Registry reconciliation' },
  'cluster.registryReconcileTitle': {
    zh: 'NameServer 注册表一致性核对',
    en: 'NameServer registry reconciliation',
  },
  'cluster.registryReconcileDescription': {
    zh: '对比持久化注册表与当前实例发现的集群及地址；该报告只读，不修改注册配置。',
    en: 'Compare persisted registry entries with clusters and addresses discovered from the current instance. This report is read-only.',
  },
  'cluster.registryReconcileDrift': {
    zh: '注册表与当前发现结果存在需要处理的差异',
    en: 'The registry and current discovery results require attention.',
  },
  'cluster.registryReconcileHealthy': {
    zh: '注册表与当前发现结果一致',
    en: 'The registry matches current discovery results.',
  },
  'cluster.registryReconcileMATCHED': { zh: '一致', en: 'Matched' },
  'cluster.registryReconcileADDRESS_MISMATCH': { zh: '地址不一致', en: 'Address mismatch' },
  'cluster.registryReconcileREGISTRY_ONLY': { zh: '仅注册表存在', en: 'Registry only' },
  'cluster.registryReconcileDISCOVERED_ONLY': { zh: '仅发现结果存在', en: 'Discovery only' },
  'cluster.registryReconcileAMBIGUOUS': { zh: '匹配不唯一', en: 'Ambiguous' },
  'cluster.registryReconcileDUPLICATE_MAPPING': { zh: '重复映射', en: 'Duplicate mapping' },
  'cluster.registryEntry': { zh: '注册表条目', en: 'Registry entry' },
  'cluster.discoveredCluster': { zh: '发现的集群', en: 'Discovered cluster' },
  'cluster.configuredAddresses': { zh: '已配置地址', en: 'Configured addresses' },
  'cluster.discoveredAddresses': { zh: '发现地址', en: 'Discovered addresses' },
  'cluster.missingAddresses': { zh: '发现结果缺少', en: 'Missing from discovery' },
  'cluster.unexpectedAddresses': { zh: '注册表缺少', en: 'Missing from registry' },
  'cluster.candidateClusters': { zh: '候选集群', en: 'Candidate clusters' },
  'cluster.registryEntries': { zh: '注册条目', en: 'Registry entries' },
  'cluster.discoveredClusters': { zh: '发现集群', en: 'Discovered clusters' },
  'cluster.registryMatched': { zh: '一致条目', en: 'Matched entries' },
  'cluster.registryAttention': { zh: '需处理', en: 'Needs attention' },
  'cluster.registryReconcileSearch': {
    zh: '搜索条目、集群或地址',
    en: 'Search entries, clusters, or addresses',
  },
  'cluster.registryReconcileEmpty': {
    zh: '没有符合条件的核对结果',
    en: 'No matching reconciliation results',
  },
