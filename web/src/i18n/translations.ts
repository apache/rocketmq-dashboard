...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // ─── Instance page ───
  'instance.listSubtitle': { zh: '接入并管理 RocketMQ 实例（开源自建 / 阿里云 / 腾讯云），当前显示 {count} 个实例', en: 'Connect and manage RocketMQ instances (self-hosted / Aliyun / Tencent Cloud); showing {count} instances' },
  'instance.typeCloud': { zh: '云服务', en: 'Cloud' },
  ...
  'instance.listLoadFailed': { zh: '实例列表加载失败，请稍后重试', en: 'Failed to load the instance list, please retry later' },
  'instance.credentialsLoadFailed': { zh: '云凭据列表加载失败', en: 'Failed to load the cloud credential list' },
  'instance.regionsLoadFailed': { zh: '云地域列表加载失败', en: 'Failed to load the cloud region list' },
  'instance.cloudInstancesLoadFailed': { zh: '云实例列表加载失败', en: 'Failed to load the cloud instance list' },
  'instance.addedNamed': { zh: '实例「{name}」添加成功', en: 'Instance "{name}" added' },
  'instance.addFailed': { zh: '添加实例失败，请稍后重试', en: 'Failed to add the instance, please retry later' },
  'instance.selectCredentialFirst': { zh: '请先选择云凭据', en: 'Select a cloud credential first' },
  'instance.importAll': { zh: '一键导入', en: 'One-Click Import' },
  'instance.importAllTooltip': { zh: '遍历该凭据下全部地域，将所有云上实例导入（幂等，已存在的自动跳过），备注自动取自云上实例', en: 'Scans every region under this credential and imports all cloud instances (idempotent; existing ones are skipped automatically). The remark is taken from the cloud instance.' },
  'instance.importComplete': { zh: '导入完成：共同步 {total} 个实例（新导入 {added}，已存在跳过 {skipped}）', en: 'Import complete: {total} instances synced ({added} new, {skipped} skipped as existing)' },
  'instance.importIncomplete': { zh: '导入未完成：新导入 {added} 个，已存在跳过 {skipped} 个', en: 'Import incomplete: {added} new, {skipped} skipped as existing' },
  'instance.importNoneNeeded': { zh: '云上实例均已在 Studio 中（共 {skipped} 个），无需重复导入', en: 'All cloud instances are already in Studio ({skipped}); no need to import' },
  'instance.importFailedSuffix': { zh: '，失败 {count} 个', en: ', {count} failed' },
  'instance.importOmitted': { zh: '（仅显示前 {count} 条）', en: ' (only the first {count} shown)' },
  'instance.importDetails': { zh: '：{names}', en: ': {names}' },
  'instance.importAllFailed': { zh: '一键导入失败，请稍后重试', en: 'One-click import failed, please retry later' },
  'instance.updatedNamed': { zh: '实例「{name}」已更新', en: 'Instance "{name}" updated' },
  'instance.updateFailed': { zh: '更新实例失败，请稍后重试', en: 'Failed to update the instance, please retry later' },
  'instance.deleteFailed': { zh: '删除实例失败，请稍后重试', en: 'Failed to delete the instance, please retry later' },
  'instance.cloudDeleteWarning': { zh: '云厂商实例仅从 Studio 移除记录，不会释放云上的 RocketMQ 实例；仍有 Topic/Group 的开源实例无法删除。', en: 'Cloud instances are only removed from Studio; the cloud RocketMQ instances are not released. Open-source instances that still have Topics/Groups cannot be deleted.' },
  'instance.batchOpenSourceWarning': { zh: '仍有 Topic/Group 的开源实例无法删除。', en: 'Open-source instances that still have Topics/Groups cannot be deleted.' },
  'instance.batchDeleteTitle': { zh: '确认删除选中的 {count} 个实例？', en: 'Delete the {count} selected instances?' },
  'instance.batchDeleteContent': { zh: '将删除：{names}。{warning}', en: 'Will delete: {names}. {warning}' },
  'instance.deletedSummary': { zh: '已删除 {count} 个', en: 'Deleted {count}' },
  'instance.batchDeletePartial': { zh: '{summary}，{count} 个未能删除：{names}', en: '{summary}; {count} could not be deleted: {names}' },
  'instance.batchDeleteFailed': { zh: '批量删除失败，请稍后重试', en: 'Batch delete failed, please retry later' },
  'instance.region': { zh: '地域', en: 'Region' },
  'instance.openSourceEdition': { zh: '开源版', en: 'Open Source' },
  'instance.vendor': { zh: '厂商', en: 'Vendor' },
  'instance.unavailable': { zh: '不可用', en: 'Unavailable' },
  'instance.deleteCloudRecordOnly': { zh: '仅从 Studio 移除该实例记录，不会释放云上的 RocketMQ 实例。', en: 'Only removes the instance record from Studio; the RocketMQ instance on the cloud is not released.' },
  'instance.cloudCredential': { zh: '云凭据', en: 'Cloud Credential' },
  'instance.selectCredentialRequired': { zh: '请选择云凭据', en: 'Select a cloud credential' },
  'instance.credentialHintPrefix': { zh: '凭据为{vendor}账号的 AK/SK，', en: 'The credential is the AK/SK of your {vendor} account. ' },
  'instance.gotoCredentialSettings': { zh: '前往「设置 - 云凭据管理」添加', en: 'add it in Settings - Cloud Credentials' },
  'instance.selectCredentialPlaceholder': { zh: '选择已录入的 AK/SK 凭据', en: 'Select a saved AK/SK credential' },
  'instance.loading': { zh: '加载中…', en: 'Loading…' },
  'instance.noCredentialsHint': { zh: '暂无{vendor}凭据，', en: 'No {vendor} credentials, ' },
  'instance.gotoSettingsAdd': { zh: '去设置中添加', en: 'add them in Settings' },
  'instance.aliyun': { zh: '阿里云', en: 'Aliyun' },
  'instance.tencent': { zh: '腾讯云', en: 'Tencent Cloud' },
  'instance.selectRegionRequired': { zh: '请选择地域', en: 'Select a region' },
  'instance.selectRegionPlaceholder': { zh: '选择地域', en: 'Select region' },
  'instance.selectRegionFirst': { zh: '请先选择地域', en: 'Select a region first' },
  'instance.cloudInstance': { zh: '云上实例', en: 'Cloud Instance' },
  'instance.selectCloudInstanceRequired': { zh: '请选择云上实例', en: 'Select a cloud instance' },
  'instance.cloudInstanceExtra': { zh: '商业版实例来自云端目录，无法手工创建', en: 'Commercial instances come from the cloud catalog and cannot be created manually' },
  'instance.selectCloudInstancePlaceholder': { zh: '选择云上实例', en: 'Select a cloud instance' },
  'instance.idRequired': { zh: '请输入实例 ID', en: 'Enter the instance ID' },
  'instance.idMaxLength': { zh: '实例 ID 不能超过 64 个字符', en: 'Instance ID must not exceed 64 characters' },
  'instance.idAutoFillPlaceholder': { zh: '默认取云上实例 ID', en: 'Defaults to the cloud instance ID' },
  'instance.selectAccessTypeRequired': { zh: '请选择接入方式', en: 'Select an access type' },
  'instance.selectAccessTypeFirst': { zh: '请先选择接入方式', en: 'Select an access type first' },
  'instance.endpointTooltip': { zh: '接入地址为客户端访问入口，会展示在 Topic 等页面供客户端配置使用。若客户端环境无法解析该地址（如 K8s 内部 Service 域名），可自行配置 DNS 解析或在客户端 hosts 中映射。', en: 'The endpoint is the client access entry and is shown on pages such as Topic for client configuration. If clients cannot resolve this address (e.g. an internal K8s Service name), configure DNS or map it in the client hosts file.' },
  'instance.endpointRequired': { zh: '请输入接入地址', en: 'Enter the endpoint' },
  'instance.endpointHintDirect': { zh: 'Direct 模式请填写 NameServer SLB 地址（K8s 场景下一般为 NameServer Service 地址，如 namesrv.mq.svc:9876）', en: 'In Direct mode, enter the NameServer SLB address (usually the NameServer Service address in K8s, e.g. namesrv.mq.svc:9876)' },
  'instance.endpointHintProxyLocal': { zh: 'Proxy Local 模式请填写与 Broker 同进程部署的 Proxy 接入地址（如 broker-proxy.mq.svc:8080）', en: 'In Proxy Local mode, enter the Proxy address deployed alongside the Broker (e.g. broker-proxy.mq.svc:8080)' },
  'instance.endpointHintProxyCluster': { zh: 'Proxy Cluster 模式请填写独立 Proxy 集群的 SLB 内网地址（如 proxy.mq.svc:8080）', en: 'In Proxy Cluster mode, enter the internal SLB address of the standalone Proxy cluster (e.g. proxy.mq.svc:8080)' },
  'instance.endpointCloudFixed': { zh: '云服务实例接入地址由云厂商目录解析，不支持手动修改', en: 'The cloud instance endpoint is resolved from the vendor catalog and cannot be edited' },
  'instance.endpointPlaceholderDirect': { zh: '例：namesrv.mq.svc.cluster.local:9876', en: 'e.g. namesrv.mq.svc.cluster.local:9876' },
  'instance.endpointPlaceholderProxy': { zh: '例：proxy.mq.svc.cluster.local:8080', en: 'e.g. proxy.mq.svc.cluster.local:8080' },
  'instance.adminCredentialRef': { zh: '管理凭据引用', en: 'Admin credential reference' },
  'instance.credentialRefExtraOptional': { zh: '可选。仅保存服务端配置中的凭据引用，不会保存或传输 AK/SK。', en: 'Optional. Stores only a reference from the server configuration; AK/SK is never saved or transmitted.' },
  'instance.credentialRefExtra': { zh: '仅保存服务端配置中的引用，不会保存或传输 AK/SK。', en: 'Stores only a reference from the server configuration; AK/SK is never saved or transmitted.' },
  'instance.credentialRefPlaceholder': { zh: '例：production-admin', en: 'e.g. production-admin' },
  'instance.save': { zh: '保存', en: 'Save' },
  'instance.editTitle': { zh: '编辑实例 — {name}', en: 'Edit Instance - {name}' },
  'instance.remarkOptionalPlaceholder': { zh: '可选，描述实例用途', en: 'Optional - describes the instance purpose' },
  'instance.remarkPlaceholderEdit': { zh: '描述实例用途', en: 'Describes the instance purpose' },
  // ─── BrokerCluster ───
};
