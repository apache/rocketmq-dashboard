...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'proxy.batchAdd': { zh: '批量新增', en: 'Batch Add' },
  'proxy.batchAddresses': { zh: '批量 Proxy 地址', en: 'Batch Proxy addresses' },
  'proxy.batchAddressPlaceholder': {
    zh: '10.0.0.10:8081\n10.0.0.11:8081\n[2001:db8::1]:8081',
    en: '10.0.0.10:8081\n10.0.0.11:8081\n[2001:db8::1]:8081',
  },
  'proxy.batchAddressRequired': {
    zh: '请输入至少一个 Proxy 地址',
    en: 'Please enter at least one Proxy address',
  },
  'proxy.batchTooManyAddresses': {
    zh: '一次最多新增 {count} 个 Proxy 地址',
    en: 'At most {count} Proxy addresses can be added at a time',
  },
  'proxy.batchAddSubmit': { zh: '批量新增', en: 'Add Addresses' },
  'proxy.batchAddSuccess': {
    zh: '已新增 {count} 个 Proxy 地址',
    en: 'Added {count} Proxy addresses',
  },
  'proxy.batchAddNoNewAddress': {
    zh: '没有新增 Proxy 地址',
    en: 'No Proxy address was added',
  },
  'proxy.batchAddFailed': {
    zh: '批量新增 Proxy 地址失败',
    en: 'Failed to add Proxy addresses',
  },
  'proxy.batchParsedCount': {
    zh: '已识别 {count} 个地址',
    en: '{count} addresses detected',
  },
  'proxy.batchRow': { zh: '行号', en: 'Row' },
  'proxy.batchInput': { zh: '原始输入', en: 'Input' },
  'proxy.batchNormalizedAddress': { zh: '标准地址', en: 'Normalized Address' },
  'proxy.batchStatusAdded': { zh: '已新增', en: 'Added' },
  'proxy.batchStatusExisting': { zh: '已存在', en: 'Existing' },
  'proxy.batchStatusDuplicate': { zh: '重复', en: 'Duplicate' },
  'proxy.batchStatusInvalid': { zh: '无效', en: 'Invalid' },
  'proxy.batchMessageAdded': { zh: 'Proxy 地址已新增', en: 'Proxy address added' },
  'proxy.batchMessageExisting': { zh: 'Proxy 地址已存在', en: 'Proxy address already exists' },
  'proxy.batchMessageDuplicate': {
    zh: '本次请求内重复',
    en: 'Duplicate address in this request',
  },
  'proxy.batchTotal': { zh: '总数', en: 'Total' },
  'proxy.batchAdded': { zh: '新增', en: 'Added' },
  'proxy.batchSkipped': { zh: '跳过', en: 'Skipped' },
  'proxy.batchInvalid': { zh: '无效', en: 'Invalid' },
