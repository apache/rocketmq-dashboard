...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // ─── Consumer offset reset flow ───
  'consumer.change': { zh: '变化', en: 'Change' },
  'consumer.confirmImpacts': { zh: '请确认以下影响', en: 'Review the following impacts' },
  'consumer.confirmReset': { zh: '确认重置', en: 'Confirm Reset' },
  'consumer.currentLagLabel': { zh: '当前堆积', en: 'Current Lag' },
  'consumer.currentOffset': { zh: '当前位点', en: 'Current Offset' },
  'consumer.currentTotalLagLabel': { zh: '当前总堆积', en: 'Current Total Lag' },
  'consumer.daysAgo': { zh: '{count} 天前', en: '{count} days ago' },
  'consumer.description': { zh: '说明', en: 'Description' },
  'consumer.fastForwardQueues': { zh: '跳过 Queue', en: 'Fast-forward Queues' },
  'consumer.hoursAgo': { zh: '{count} 小时前', en: '{count} hours ago' },
  'consumer.netOffsetChange': { zh: '位点净变化', en: 'Net Offset Change' },
  'consumer.noPreviewQueues': { zh: '未找到可预览的 Queue 位点', en: 'No Queue offsets available to preview' },
  'consumer.noSubTopics': { zh: '该 Group 暂无订阅 Topic', en: 'This Group has no subscribed Topic' },
  'consumer.previewAtMax': { zh: '目标为最新位点', en: 'Target is the latest offset' },
  'consumer.previewAtMin': { zh: '目标为最小保留位点', en: 'Target is the minimum retained offset' },
  'consumer.previewComplete': { zh: '完整', en: 'Complete' },
  'consumer.previewDone': { zh: '已预览 {count} 个 Queue', en: 'Previewed {count} Queues' },
  'consumer.previewFailed': { zh: '预览失败', en: 'Preview failed' },
  'consumer.previewFailedReason': { zh: '预览重置影响失败', en: 'Failed to preview the reset impact' },
  'consumer.previewFailedTitle': { zh: '位点预览失败', en: 'Offset preview failed' },
  'consumer.previewFastForward': { zh: '将跳过 {count} 条未消费消息', en: 'Will skip {count} unconsumed messages' },
  'consumer.previewImpactButton': { zh: '预览影响', en: 'Preview Impact' },
  'consumer.previewIncomplete': { zh: '不完整', en: 'Incomplete' },
  'consumer.previewLimited': { zh: '有限', en: 'Limited' },
  'consumer.previewNoQueuesWarning': { zh: '预览未覆盖可重置队列，请检查 Group/Topic 状态', en: 'Preview did not cover any resettable queues; check the Group/Topic state' },
  'consumer.previewNotConfirmedWarning': { zh: '请先预览并确认位点影响', en: 'Preview and confirm the offset impact first' },
  'consumer.previewNotice': { zh: '预览不会修改 broker 位点，仅计算目标时间对应的 Queue offset。', en: 'Preview does not modify broker offsets; it only calculates the Queue offsets for the target time.' },
  'consumer.previewRewind': { zh: '将回放 {count} 条消息', en: 'Will replay {count} messages' },
  'consumer.previewStatus': { zh: '预览状态', en: 'Preview Status' },
  'consumer.previewTargetUnavailable': { zh: '目标位点不可用', en: 'Target offset unavailable' },
  'consumer.previewUnchanged': { zh: '位点不变', en: 'Offset unchanged' },
  'consumer.projectedLag': { zh: '重置后堆积', en: 'Projected Lag' },
  'consumer.projectedTotalLagLabel': { zh: '重置后总堆积', en: 'Projected Total Lag' },
  'consumer.queueCountLabel': { zh: 'Queue 数', en: 'Queues' },
  'consumer.quickSelect': { zh: '快捷选择', en: 'Quick Select' },
  'consumer.resetDone': { zh: '{name} 在 {topic} 的消费位点已重置到 {time}', en: 'Consume offset of {name} on {topic} reset to {time}' },
  'consumer.resetImpactDesc': { zh: '请先预览每个 Queue 的目标位点和堆积变化，确认预览结果后再执行重置。预览为时点快照、属页面操作引导（非服务端控制），预览期间消息持续写入，实际效果以执行时 Broker 状态为准。', en: 'Preview the target offset and lag change of every Queue first, then confirm before resetting. The preview is a point-in-time snapshot used as a page-level guide (not a server-side control); messages keep arriving while previewing, so the actual result depends on the Broker state at execution time.' },
  'consumer.resetImpactTitle': { zh: '此操作将影响消息消费进度', en: 'This will affect the message consumption progress' },
  'consumer.resetOffsetTitle': { zh: '重置消费位点', en: 'Reset Consume Offset' },
  'consumer.resetRiskError': { zh: '失败', en: 'Failed' },
  'consumer.resetRiskOk': { zh: '正常', en: 'Normal' },
  'consumer.resetRiskWarning': { zh: '需确认', en: 'Needs confirmation' },
  'consumer.resetTargetGroup': { zh: '目标 Group', en: 'Target Group' },
  'consumer.resetTargetTopic': { zh: '目标 Topic', en: 'Target Topic' },
  'consumer.resetTimePlaceholder': { zh: '选择重置时间点', en: 'Select a reset time' },
  'consumer.resetToTimeLabel': { zh: '重置到以下时间点', en: 'Reset to the following time' },
  'consumer.resetTopicPlaceholder': { zh: '选择要重置消费位点的 Topic', en: 'Select the Topic whose offset to reset' },
  'consumer.rewindQueues': { zh: '回放 Queue', en: 'Rewind Queues' },
  'consumer.risk': { zh: '风险', en: 'Risk' },
  'consumer.selectTopicToReset': { zh: '请先选择要重置的 Topic', en: 'Select a Topic to reset first' },
  'consumer.subTopicLoadFailed': { zh: '订阅 Topic 加载失败', en: 'Failed to load subscribed Topics' },
  'consumer.targetOffset': { zh: '目标位点', en: 'Target Offset' },
  // ─── BrokerCluster ───
};
