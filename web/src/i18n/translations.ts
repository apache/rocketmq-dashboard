...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'consumer.allConsistent': { zh: '全部 {count} 个订阅配置一致', en: 'All {count} subscription configs are consistent' },
  'consumer.allTopics': { zh: '全部 Topic', en: 'All Topics' },
  'consumer.consistencyCheck': { zh: '订阅一致性检查', en: 'Subscription Consistency Check' },
  'consumer.consistencyCheckFailed': { zh: '订阅一致性检查失败，当前保留上次检查结果', en: 'Consistency check failed; keeping the previous result' },
  'consumer.consistencyChecking': { zh: '正在检查订阅一致性', en: 'Checking subscription consistency…' },
  'consumer.emptyProgress': { zh: '消费组不在线，暂无队列进度数据', en: 'Consumer group is offline; no queue progress data' },
  'consumer.inconsistencyFound': { zh: '发现 {count} 个订阅配置不一致', en: 'Found {count} inconsistent subscription config(s)' },
  'consumer.noSubsToCheck': { zh: '暂无订阅关系可检查', en: 'No subscriptions to check' },
  'consumer.onlyInconsistent': { zh: '仅看不一致', en: 'Show Only Inconsistent' },
  'consumer.progressTab': { zh: '消费进度', en: 'Consumption Progress' },
  'consumer.reCheck': { zh: '重新检查', en: 'Re-check' },
  'consumer.topicFilterLabel': { zh: 'Topic 筛选:', en: 'Topic filter:' },
  'consumer.totalBrokers': { zh: '总 Broker 数:', en: 'Total brokers:' },
  'consumer.totalBacklogCol': { zh: '总堆积:', en: 'Total backlog:' },
  'consumer.totalQueues': { zh: '总 Queue 数:', en: 'Total queues:' },
  'consumer.unknownSubs': { zh: '{count} 个订阅配置状态未知', en: '{count} subscription config(s) with unknown status' },
