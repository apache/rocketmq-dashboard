...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // ─── Message page ───
  'message.bodyTitle': { zh: '消息体', en: 'Message Body' },
  'message.brokerReturned': { zh: 'Broker 返回 {detail}，耗时 {ms} ms', en: 'Broker returned {detail}, took {ms} ms' },
  'message.close': { zh: '关闭', en: 'Close' },
  'message.consumeSuccessRate': { zh: '消费成功率', en: 'Consume Success Rate' },
  'message.consumeTime': { zh: '消费时间', en: 'Consume Time' },
  'message.consumerGroup': { zh: '消费者组', en: 'Consumer Group' },
  'message.consumerGroupPlaceholder': { zh: '目标消费者组', en: 'Target consumer group' },
  ...
  'message.deliverySuccess': { zh: '成功', en: 'Succeeded' },
  'message.detailAction': { zh: '详情', en: 'Detail' },
  'message.directConsume': { zh: '直接消费', en: 'Consume Directly' },
  'message.directConsumeFailed': { zh: '直接消费请求失败，请检查消费组和客户端是否在线', en: 'Direct consume request failed; check that the consumer group and client are online' },
  'message.directConsumeNotConfigured': { zh: '请填写目标消费组和在线客户端 ID', en: 'Fill in the target consumer group and online client ID' },
  'message.directConsumeNotice': { zh: 'Broker 会请求指定在线客户端立即消费该消息。', en: 'The Broker will ask the specified online client to consume this message immediately.' },
  'message.directConsumeNoticeDesc': { zh: '这不是向 Topic 重新发送消息；Broker 返回的消费结果会原样显示。', en: 'This is not re-sending the message to the Topic; the consumption result returned by the Broker is shown as-is.' },
  'message.directConsumeTitle': { zh: '直接消费消息', en: 'Consume Message Directly' },
  'message.downloadAction': { zh: '下载', en: 'Download' },
  'message.downloaded': { zh: '消息下载成功', en: 'Message downloaded' },
  'message.endToEndLatency': { zh: '端到端耗时', en: 'End-to-End Latency' },
  'message.enterKeyError': { zh: '请输入 Message Key', en: 'Enter a Message Key' },
  'message.enterMsgIdError': { zh: '请输入 Message ID', en: 'Enter a Message ID' },
  'message.execute': { zh: '执行', en: 'Execute' },
  'message.healthScore': { zh: '健康分', en: 'Health Score' },
  'message.historyLoadFailed': { zh: '加载历史结果失败', en: 'Failed to load historical results' },
  'message.historyLoaded': { zh: '已加载历史查询结果，共 {count} 条', en: 'Loaded {count} historical query results' },
  'message.inputKeyPlaceholder': { zh: '输入 Message Key', en: 'Enter a Message Key' },
  'message.inputMsgIdPlaceholder': { zh: '输入 Message ID', en: 'Enter a Message ID' },
  'message.issueDetail': { zh: '说明', en: 'Description' },
  'message.issueLevel': { zh: '级别', en: 'Level' },
  'message.issueRisk': { zh: '风险', en: 'Risk' },
  'message.largestGap': { zh: '；最大阶段间隔：{stage}，{duration}', en: '; largest gap between stages: {stage}, {duration}' },
  'message.loadingTopics': { zh: '正在加载 Topic 列表', en: 'Loading Topic list' },
  'message.noTraceData': { zh: '暂无轨迹数据', en: 'No trace data' },
  'message.onlineClientPlaceholder': { zh: '在线客户端 ID', en: 'Online client ID' },
  'message.pleaseSelectInstance': { zh: '请先选择实例', en: 'Select an instance first' },
  'message.queryButton': { zh: '查询', en: 'Query' },
  'message.queryByKey': { zh: '按 Message Key', en: 'Search by Message Key' },
  'message.queryByMsgId': { zh: '按 Message ID', en: 'Search by Message ID' },
  'message.queryByQueue': { zh: '按队列浏览', en: 'Browse by Queue' },
  'message.queryByTopic': { zh: '按 Topic 查询', en: 'Search by Topic' },
  'message.queryComplete': { zh: '查询完成，共 {count} 条', en: 'Query complete: {count} messages' },
  'message.queryFailedFallback': { zh: '消息查询失败，请稍后重试', en: 'Message query failed, please retry later' },
  'message.resetButton': { zh: '重置', en: 'Reset' },
  'message.retry': { zh: '重试', en: 'Retry' },
  'message.retryCount': { zh: '重试次数', en: 'Retry Count' },
  'message.runTrace': { zh: '查询轨迹', en: 'Query Trace' },
  'message.selectInstanceFirstQuery': { zh: '请先选择实例后再查询消息', en: 'Select an instance before querying messages' },
  'message.selectTopicError': { zh: '请选择 Topic', en: 'Select a Topic' },
  'message.selectTopicPlaceholder': { zh: '选择 Topic', en: 'Select Topic' },
  'message.serverHistoryButton': { zh: '服务端历史', en: 'Server History' },
  'message.size': { zh: '大小', en: 'Size' },
  'message.slowestStage': { zh: '最慢阶段：{stage}，{duration}', en: 'Slowest stage: {stage}, {duration}' },
  'message.stageCostTotal': { zh: '阶段耗时合计', en: 'Total Stage Time' },
  'message.stepCost': { zh: '耗时 {ms}ms', en: 'took {ms}ms' },
  'message.storeTime': { zh: '存储时间', en: 'Store Time' },
  'message.tabContent': { zh: '消息内容', en: 'Message Content' },
  'message.tabTrace': { zh: '消息轨迹', en: 'Message Trace' },
  'message.tabVerify': { zh: '验证', en: 'Verify' },
  'message.topicListFailed': { zh: 'Topic 列表加载失败', en: 'Failed to load the Topic list' },
  'message.topicListFailedFallback': { zh: '加载 Topic 列表失败', en: 'Failed to load the Topic list' },
  'message.topicListFailedRetry': { zh: 'Topic 列表加载失败，请先重试', en: 'Failed to load the Topic list, retry first' },
  'message.total': { zh: '共 {count} 条消息', en: '{count} messages total' },
  'message.traceAction': { zh: '轨迹', en: 'Trace' },
  'message.traceDiagnostics': { zh: '轨迹诊断', en: 'Trace Diagnostics' },
  'message.traceFailedFallback': { zh: '消息轨迹加载失败，请稍后重试', en: 'Message trace failed to load, please retry later' },
  'message.traceKeyPlaceholder': { zh: '输入 Message Key', en: 'Enter a Message Key' },
  'message.traceLoading': { zh: '正在加载轨迹数据…', en: 'Loading trace data…' },
  'message.traceMsgIdPlaceholder': { zh: '消息 ID（默认当前消息）', en: 'Message ID (defaults to the current message)' },
  'message.traceStages': { zh: '轨迹阶段', en: 'Trace Stages' },
  'message.traceTopicPlaceholder': { zh: '轨迹 Topic（留空使用默认）', en: 'Trace Topic (leave blank to use default)' },
  'message.truncatedWarning': { zh: '查询结果达到服务端扫描上限，当前总数可能不完整。', en: 'The results reached the server scan limit, so the total may be incomplete.' },
  'message.verifyAction': { zh: '验证', en: 'Verify' },
  'message.verifyNotReady': { zh: '消费验证接口尚未接入，无法确认该消息的真实消费状态', en: 'The consume verification endpoint is not wired up yet; the real consumption state cannot be confirmed' },
  // ─── BrokerCluster ───
};
