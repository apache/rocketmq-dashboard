...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // ─── Topic import & sync flows ───
  'topic.close': { zh: '关闭', en: 'Close' },
  'topic.csvNotImportable': { zh: 'CSV 无法导入', en: 'CSV cannot be imported' },
  'topic.csvParseFailed': { zh: 'CSV 解析失败', en: 'Failed to parse CSV' },
  'topic.description': { zh: '说明', en: 'Description' },
  'topic.importColumnsNote': { zh: '仅导入可创建字段；CSV 中的 Namespace、Cluster ID 和运行状态列会被忽略。', en: 'Only creatable fields are imported; the Namespace, Cluster ID and runtime status columns in the CSV are ignored.' },
  'topic.importFailed': { zh: '{count} 个 Topic 导入失败', en: 'Failed to import {count} Topics' },
  'topic.importFailedShort': { zh: '失败', en: 'Failed' },
  'topic.importInvalid': { zh: '无效', en: 'Invalid' },
  'topic.importPartialFailed': { zh: '已导入 {imported} 个 Topic，{failed} 个失败', en: '{imported} Topics imported, {failed} failed' },
  'topic.importPending': { zh: '待导入', en: 'Pending' },
  'topic.importPlanNotice': { zh: '检测到 {count} 个 Topic，将通过后端批量导入', en: '{count} Topics detected; they will be imported in batch through the backend' },
  'topic.importSuccess': { zh: '成功', en: 'Success' },
  'topic.importTitle': { zh: '导入 Topic', en: 'Import Topics' },
  'topic.importTitleWithFile': { zh: '导入 Topic：{file}', en: 'Import Topics: {file}' },
  'topic.importWithInvalid': { zh: '已导入 {imported} 个 Topic，{invalid} 行无效已跳过', en: '{imported} Topics imported; {invalid} invalid rows skipped' },
  'topic.imported': { zh: '已导入 {count} 个 Topic', en: '{count} Topics imported' },
  'topic.invalidRowsNotice': { zh: '检测到 {count} 行无效，将跳过这些行', en: '{count} invalid rows detected; they will be skipped' },
  'topic.lineNumber': { zh: '行号', en: 'Line' },
  'topic.rebuildFailed': { zh: '重建 Topic 失败，请检查 Broker 状态后重试', en: 'Failed to rebuild the Topic, check the Broker state and retry' },
  'topic.rebuilt': { zh: 'Topic「{name}」已在 Broker 上重建', en: 'Topic "{name}" rebuilt on the Broker' },
  'topic.retryFailedItems': { zh: '重试失败项', en: 'Retry Failed Items' },
  'topic.routeCheckPartialFailed': { zh: '部分 Topic 路由校验失败，请稍后重试', en: 'Some Topic route checks failed, please retry later' },
  'topic.rowCreateFailed': { zh: '创建失败', en: 'Create failed' },
  'topic.rowCreated': { zh: '已创建', en: 'Created' },
  'topic.selectInstanceFirst': { zh: '请先选择实例', en: 'Select an instance first' },
  'topic.startImport': { zh: '开始导入', en: 'Start Import' },
  'topic.syncAction': { zh: '同步', en: 'Sync' },
  'topic.syncAllUpToDate': { zh: '所有 Topic 在 Broker 上均有路由，无需同步。', en: 'All Topics already have routes on the Broker; no sync needed.' },
  'topic.syncChecking': { zh: '正在校验 Topic 路由…', en: 'Checking Topic routes…' },
  'topic.syncData': { zh: '同步数据', en: 'Sync Data' },
  'topic.syncIntro': { zh: '以下 {count} 个 Topic 在 Broker 上找不到路由，可同步写入对应集群的 Broker（按元数据记录的队列数重建）。', en: 'The following {count} Topics have no route on the Broker; they can be written to the corresponding cluster Broker (rebuilt with the queue counts from metadata).' },
  'topic.syncMissingRoute': { zh: '缺失路由', en: 'Missing Route' },
  'topic.syncQueueColumns': { zh: '写/读队列数', en: 'Write/Read Queues' },
  'topic.syncSynced': { zh: '已同步', en: 'Synced' },
  'topic.syncToBrokerFailed': { zh: '同步 Topic「{name}」失败，请检查 Broker 状态后重试', en: 'Failed to sync Topic "{name}", check the Broker state and retry' },
  'topic.syncedToBroker': { zh: 'Topic「{name}」已同步到 Broker', en: 'Topic "{name}" synced to the Broker' },
  // ─── BrokerCluster ───
};
