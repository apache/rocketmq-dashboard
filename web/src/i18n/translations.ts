...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'topic.batchDeleteError': { zh: '批量删除 Topic 失败，请稍后重试', en: 'Failed to delete topics in batch, please retry later' },
  'topic.batchDeleteFailed': { zh: '{failed} 个 Topic 删除失败，请稍后重试', en: '{failed} topic(s) failed to delete, please retry later' },
  'topic.createFailed': { zh: '创建 Topic 失败，请稍后重试', en: 'Failed to create topic, please retry later' },
  'topic.created': { zh: 'Topic「{name}」创建成功', en: 'Topic "{name}" created' },
  'topic.deleteFailed': { zh: '删除 Topic 失败，请稍后重试', en: 'Failed to delete topic, please retry later' },
  'topic.detailLoadFailed': { zh: 'Topic 详情加载失败，请稍后重试', en: 'Failed to load topic details, please retry later' },
  ...
  'topic.importDone': { zh: '已导入 {created} 个 Topic', en: 'Imported {created} topics' },
  'topic.importFailed': { zh: '{failed} 个 Topic 导入失败', en: '{failed} topic(s) failed to import' },
  'topic.importPartialFailed': { zh: '已导入 {created} 个 Topic，{failed} 个失败', en: 'Imported {created} topics; {failed} failed' },
  'topic.importPartialInvalid': { zh: '已导入 {created} 个 Topic，{invalid} 行无效已跳过', en: 'Imported {created} topics; {invalid} invalid row(s) skipped' },
  'topic.loadFailed': { zh: 'Topic 列表加载失败，请稍后重试', en: 'Failed to load topics, please retry later' },
  'topic.messagePropsInvalid': { zh: '消息属性格式错误：{details}', en: 'Invalid message properties: {details}' },
  'topic.messageSent': { zh: '消息发送成功！MsgId: {msgId}', en: 'Message sent! MsgId: {msgId}' },
  'topic.rebuildFailed': { zh: '重建 Topic 失败，请检查 Broker 状态后重试', en: 'Failed to rebuild topic; check the broker status and retry' },
  'topic.rebuilt': { zh: 'Topic「{name}」已在 Broker 上重建', en: 'Topic "{name}" rebuilt on the broker' },
  'topic.routeCheckFailed': { zh: '部分 Topic 路由校验失败，请稍后重试', en: 'Some topic routes failed validation, please retry later' },
  'topic.selectInstanceFirst': { zh: '请先选择实例', en: 'Select an instance first' },
  'topic.sendFailed': { zh: '消息发送失败，请稍后重试', en: 'Failed to send message, please retry later' },
  'topic.synced': { zh: 'Topic「{name}」已同步到 Broker', en: 'Topic "{name}" synced to the broker' },
  'topic.syncFailed': { zh: '同步 Topic「{name}」失败，请检查 Broker 状态后重试', en: 'Failed to sync topic "{name}"; check the broker status and retry' },
