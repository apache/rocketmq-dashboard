...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'dlq.batchResendSelected': { zh: '批量重发选中 ({count})', en: 'Batch Resend Selected ({count})' },
  'dlq.confirmResend': { zh: '确认重投', en: 'Confirm Resend' },
  'dlq.deadCount': { zh: '死信数量', en: 'DLQ Count' },
  'dlq.detailTitle': { zh: 'DLQ 消息明细', en: 'DLQ Message Details' },
  'dlq.exportAll': { zh: '导出全部', en: 'Export All' },
  'dlq.exportSelected': { zh: '导出选中 ({count})', en: 'Export Selected ({count})' },
  'dlq.exportTimeRange': { zh: '导出时间范围', en: 'Export Time Range' },
  'dlq.lastEnqueueTime': { zh: '最近入队时间', en: 'Last Enqueued At' },
  'dlq.messageUnit': { zh: '条', en: ' messages' },
  'dlq.resendTimeRange': { zh: '重投时间范围', en: 'Resend Time Range' },
  'dlq.resendTitle': { zh: '重投死信消息', en: 'Resend DLQ Messages' },
  'dlq.resendWarning': { zh: '⚠️ 重投操作将把死信消息重新发送到指定 Topic，请确认目标 Topic 正确。', en: 'The resend operation re-sends DLQ messages to the specified topic; make sure the target topic is correct.' },
