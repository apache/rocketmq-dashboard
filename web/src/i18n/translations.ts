...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'instance.cloudEndpointNotEditable': { zh: '云服务实例接入地址由云厂商目录解析，不支持手动修改', en: 'The access address of a cloud instance is resolved from the cloud vendor catalog and cannot be edited manually' },
  ...
  'instance.editCredentialRefHelp': { zh: '仅保存服务端配置中的引用，不会保存或传输 AK/SK。', en: 'Only the reference in the server config is stored; AK/SK is never saved or transmitted.' },
  'instance.editInstanceTitle': { zh: '编辑实例 — {name}', en: 'Edit Instance — {name}' },
  'instance.editRemarkPlaceholder': { zh: '描述实例用途', en: 'Describe the instance purpose' },
