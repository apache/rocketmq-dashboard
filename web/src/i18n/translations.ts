...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'deliveryAnalytics.open': { zh: '可靠性分析', en: 'Reliability Analytics' },
  'deliveryAnalytics.title': { zh: '通知投递可靠性分析', en: 'Notification Delivery Reliability' },
  'deliveryAnalytics.description': {
    zh: '跨分页分析通知渠道成功率、投递耗时、重试、停滞记录和重复错误签名，帮助定位渠道级故障。',
    en: 'Analyze delivery success, latency, retries, stalled records, and recurring error signatures across pages to identify channel-level failures.',
  },
  'deliveryAnalytics.readOnly': {
    zh: '该分析只读取投递历史，不会自动重试或修改记录；最多读取最近 10,000 条。',
    en: 'This analysis only reads delivery history and never retries or mutates records. It loads at most 10,000 recent records.',
  },
  'deliveryAnalytics.load': { zh: '加载分析', en: 'Load analytics' },
  'deliveryAnalytics.loadFailed': {
    zh: '投递历史加载失败，请稍后重试',
    en: 'Failed to load delivery history.',
  },
  'deliveryAnalytics.empty': {
    zh: '尚未加载投递分析',
    en: 'Delivery analytics have not been loaded.',
  },
  'deliveryAnalytics.truncated': {
    zh: '历史记录共 {total} 条，本次按上限分析最近 {loaded} 条。',
    en: 'There are {total} records. This review is capped at the latest {loaded}.',
  },
  'deliveryAnalytics.total': { zh: '投递总数', en: 'Total deliveries' },
  'deliveryAnalytics.delivered': { zh: '已送达', en: 'Delivered' },
  'deliveryAnalytics.failed': { zh: '失败', en: 'Failed' },
  'deliveryAnalytics.inFlight': { zh: '进行中', en: 'In flight' },
  'deliveryAnalytics.stuck': { zh: '停滞超过 15 分钟', en: 'Stalled over 15 min' },
  'deliveryAnalytics.retried': { zh: '发生重试', en: 'Retried' },
  'deliveryAnalytics.successRate': { zh: '终态成功率', en: 'Terminal success rate' },
  'deliveryAnalytics.averageLatency': { zh: '平均耗时', en: 'Average latency' },
  'deliveryAnalytics.p95Latency': { zh: 'P95 投递耗时', en: 'P95 latency' },
  'deliveryAnalytics.channel': { zh: '通知渠道', en: 'Channel' },
  'deliveryAnalytics.errorSignature': { zh: '错误签名', en: 'Error signature' },
  'deliveryAnalytics.occurrences': { zh: '出现次数', en: 'Occurrences' },
  'deliveryAnalytics.affectedAlerts': { zh: '影响告警数', en: 'Affected alerts' },
  'deliveryAnalytics.latestAt': { zh: '最近出现', en: 'Latest occurrence' },
  'deliveryAnalytics.alert': { zh: '告警', en: 'Alert' },
  'deliveryAnalytics.instance': { zh: '实例', en: 'Instance' },
  'deliveryAnalytics.status': { zh: '投递状态', en: 'Delivery status' },
  'deliveryAnalytics.health': { zh: '健康状态', en: 'Health' },
  'deliveryAnalytics.attempts': { zh: '尝试次数', en: 'Attempts' },
  'deliveryAnalytics.latency': { zh: '投递耗时', en: 'Latency' },
  'deliveryAnalytics.createdAt': { zh: '创建时间', en: 'Created at' },
  'deliveryAnalytics.health.HEALTHY': { zh: '正常', en: 'Healthy' },
  'deliveryAnalytics.health.IN_FLIGHT': { zh: '进行中', en: 'In flight' },
  'deliveryAnalytics.health.DEGRADED': { zh: '已停滞', en: 'Stalled' },
  'deliveryAnalytics.health.CRITICAL': { zh: '失败', en: 'Failed' },
  'deliveryAnalytics.search': {
    zh: '搜索告警、实例或错误',
    en: 'Search alert, instance, or error',
  },
  'deliveryAnalytics.channelFilter': { zh: '渠道筛选', en: 'Filter channel' },
  'deliveryAnalytics.healthFilter': { zh: '健康状态筛选', en: 'Filter health' },
  'deliveryAnalytics.allChannels': { zh: '全部渠道', en: 'All channels' },
  'deliveryAnalytics.allHealth': { zh: '全部健康状态', en: 'All health states' },
  'deliveryAnalytics.retriedOnly': { zh: '仅发生重试', en: 'Retried only' },
  'deliveryAnalytics.export': { zh: '导出分析结果', en: 'Export analytics' },
  'deliveryAnalytics.exported': {
    zh: '已导出 {count} 条投递分析记录',
    en: 'Exported {count} delivery rows.',
  },
  'deliveryAnalytics.visible': {
    zh: '当前筛选显示 {count} 条投递记录',
    en: '{count} delivery records match the filters.',
  },
  'deliveryAnalytics.channelTab': { zh: '渠道概览', en: 'Channel overview' },
  'deliveryAnalytics.errorTab': { zh: '错误签名 ({count})', en: 'Error signatures ({count})' },
  'deliveryAnalytics.deliveryTab': { zh: '投递明细 ({count})', en: 'Deliveries ({count})' },
