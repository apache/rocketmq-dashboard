...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'producerComposition.open': { zh: 'Group 构成报告', en: 'Group Composition' },
  'producerComposition.title': {
    zh: 'Producer Group 客户端构成报告',
    en: 'Producer Group Client Composition',
  },
  'producerComposition.description': {
    zh: '将当前查询连接按 Producer Group 拆分，定位重复 Client ID、版本/语言混用和元数据缺失。版本差异仅作为可见性提示，不自动判定不兼容。',
    en: 'Break down current connections by Producer Group to locate duplicate client IDs, version/language diversity, and incomplete metadata. Version differences are visibility signals, not incompatibility claims.',
  },
  'producerComposition.scope': {
    zh: '数据范围：实例 {instance}，Topic {topic}；不发起额外后端请求。',
    en: 'Scope: instance {instance}, topic {topic}. No additional backend request is made.',
  },
  'producerComposition.empty': {
    zh: '当前查询没有 Producer 连接',
    en: 'The current query has no producer connections.',
  },
  'producerComposition.groups': { zh: 'Group 数', en: 'Groups' },
  'producerComposition.connections': { zh: '连接数', en: 'Connections' },
  'producerComposition.healthy': { zh: '正常 Group', en: 'Healthy groups' },
  'producerComposition.warning': { zh: '关注 Group', en: 'Warning groups' },
  'producerComposition.critical': { zh: '高风险 Group', en: 'Critical groups' },
  'producerComposition.group': { zh: 'Producer Group', en: 'Producer Group' },
  'producerComposition.health': { zh: '状态', en: 'Health' },
  'producerComposition.clients': { zh: '唯一 Client', en: 'Unique clients' },
  'producerComposition.addresses': { zh: '唯一地址', en: 'Unique addresses' },
  'producerComposition.languages': { zh: '语言分布', en: 'Languages' },
  'producerComposition.versions': { zh: '版本分布', en: 'Versions' },
  'producerComposition.findings': { zh: '发现项', en: 'Findings' },
  'producerComposition.noFindings': { zh: '未发现异常', en: 'No findings' },
  'producerComposition.unreported': { zh: '未上报 Group', en: 'Unreported group' },
  'producerComposition.health.HEALTHY': { zh: '正常', en: 'Healthy' },
  'producerComposition.health.WARNING': { zh: '关注', en: 'Warning' },
  'producerComposition.health.CRITICAL': { zh: '高风险', en: 'Critical' },
  'producerComposition.finding.DUPLICATE_CLIENT_ID': {
    zh: 'Group 内 Client ID 重复',
    en: 'Duplicate client ID in group',
  },
  'producerComposition.finding.MIXED_VERSION': {
    zh: '存在多个客户端版本',
    en: 'Multiple client versions',
  },
  'producerComposition.finding.MIXED_LANGUAGE': {
    zh: '存在多种客户端语言',
    en: 'Multiple client languages',
  },
  'producerComposition.finding.INCOMPLETE_METADATA': {
    zh: '客户端元数据不完整',
    en: 'Incomplete client metadata',
  },
  'producerComposition.finding.UNREPORTED_GROUP': {
    zh: '未上报 Producer Group',
    en: 'Producer Group not reported',
  },
  'producerComposition.search': {
    zh: '搜索 Group、Client、地址或版本',
    en: 'Search group, client, address, or version',
  },
  'producerComposition.healthFilter': { zh: '状态筛选', en: 'Filter health' },
  'producerComposition.findingFilter': { zh: '发现项筛选', en: 'Filter finding' },
  'producerComposition.allHealth': { zh: '全部状态', en: 'All health states' },
  'producerComposition.allFindings': { zh: '全部发现项', en: 'All findings' },
  'producerComposition.export': { zh: '导出构成报告', en: 'Export composition' },
  'producerComposition.exported': { zh: '已导出 {count} 个 Group', en: 'Exported {count} groups.' },
  'producerComposition.visible': {
    zh: '当前显示 {count} 个 Producer Group',
    en: 'Showing {count} Producer Groups.',
  },
  'producerComposition.clientIds': { zh: 'Client ID 明细', en: 'Client IDs' },
  'producerComposition.clientAddresses': { zh: '客户端地址明细', en: 'Client addresses' },
