...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'capabilityMatrix.open': { zh: '能力矩阵', en: 'Capability Matrix' },
  'capabilityMatrix.title': { zh: '实例能力覆盖矩阵', en: 'Instance Capability Matrix' },
  'capabilityMatrix.description': {
    zh: '批量读取服务端声明的实例能力，识别不同厂商与接入方式之间的功能覆盖和缺口。加载失败仅标记为未知，不会误判为不支持。',
    en: 'Read server-declared capabilities in batches to identify coverage and gaps across vendors and access types. Failed discovery is marked unknown, never unsupported.',
  },
  'capabilityMatrix.instances': { zh: '待检查实例', en: 'Instances to inspect' },
  'capabilityMatrix.selectRequired': {
    zh: '请至少选择一个实例',
    en: 'Select at least one instance.',
  },
  'capabilityMatrix.noInstances': { zh: '暂无可检查的实例', en: 'No instances are available.' },
  'capabilityMatrix.load': { zh: '加载能力', en: 'Load capabilities' },
  'capabilityMatrix.partialFailure': {
    zh: '{count} 个实例的能力发现失败，其他实例结果仍然可用。',
    en: 'Capability discovery failed for {count} instances. Other results remain available.',
  },
  'capabilityMatrix.exported': {
    zh: '已导出 {count} 条能力矩阵记录',
    en: 'Exported {count} capability matrix rows.',
  },
  'capabilityMatrix.requested': { zh: '检查实例', en: 'Requested' },
  'capabilityMatrix.loaded': { zh: '发现成功', en: 'Loaded' },
  'capabilityMatrix.fullCoverage': { zh: '能力完整', en: 'Full coverage' },
  'capabilityMatrix.limited': { zh: '存在缺口', en: 'Limited' },
  'capabilityMatrix.failed': { zh: '发现失败', en: 'Failed' },
  'capabilityMatrix.coverageSummary': { zh: '能力覆盖概览', en: 'Capability coverage' },
  'capabilityMatrix.instance': { zh: '实例', en: 'Instance' },
  'capabilityMatrix.vendor': { zh: '厂商', en: 'Vendor' },
  'capabilityMatrix.accessType': { zh: '接入方式', en: 'Access type' },
  'capabilityMatrix.coverage': { zh: '覆盖数', en: 'Coverage' },
  'capabilityMatrix.gaps': { zh: '能力缺口', en: 'Capability gaps' },
  'capabilityMatrix.supported': { zh: '支持', en: 'Supported' },
  'capabilityMatrix.missing': { zh: '缺失', en: 'Missing' },
  'capabilityMatrix.unknown': { zh: '未知', en: 'Unknown' },
  'capabilityMatrix.noGaps': { zh: '完整覆盖', en: 'Full coverage' },
  'capabilityMatrix.discoveryUnavailable': { zh: '能力发现不可用', en: 'Discovery unavailable' },
  'capabilityMatrix.search': {
    zh: '搜索实例、地址或错误',
    en: 'Search instance, endpoint, or error',
  },
  'capabilityMatrix.vendorFilter': { zh: '厂商筛选', en: 'Filter vendor' },
  'capabilityMatrix.typeFilter': { zh: '接入方式筛选', en: 'Filter access type' },
  'capabilityMatrix.capabilityFilter': { zh: '能力筛选', en: 'Filter capability' },
  'capabilityMatrix.supportFilter': { zh: '支持状态筛选', en: 'Filter support status' },
  'capabilityMatrix.statusFilter': { zh: '发现状态筛选', en: 'Filter discovery status' },
  'capabilityMatrix.allVendors': { zh: '全部厂商', en: 'All vendors' },
  'capabilityMatrix.allTypes': { zh: '全部接入方式', en: 'All access types' },
  'capabilityMatrix.allCapabilities': { zh: '全部能力', en: 'All capabilities' },
  'capabilityMatrix.allSupport': { zh: '全部支持状态', en: 'All support statuses' },
  'capabilityMatrix.allStatuses': { zh: '全部发现状态', en: 'All discovery statuses' },
  'capabilityMatrix.export': { zh: '导出矩阵', en: 'Export matrix' },
  'capabilityMatrix.visibleSummary': {
    zh: '当前显示 {count} 个实例，其中 {limited} 个存在能力缺口，{failed} 个发现失败。',
    en: 'Showing {count} instances: {limited} have capability gaps and {failed} failed discovery.',
  },
  'capabilityMatrix.TOPIC_MANAGEMENT': { zh: 'Topic 管理', en: 'Topic management' },
  'capabilityMatrix.CONSUMER_GROUP_MANAGEMENT': {
    zh: '消费组管理',
    en: 'Consumer Group management',
  },
  'capabilityMatrix.MESSAGE_QUERY': { zh: '消息查询', en: 'Message query' },
  'capabilityMatrix.MESSAGE_TRACE': { zh: '消息轨迹', en: 'Message trace' },
  'capabilityMatrix.ACL_MANAGEMENT': { zh: 'ACL 管理', en: 'ACL management' },
  'capabilityMatrix.DLQ_MANAGEMENT': { zh: '死信管理', en: 'DLQ management' },
