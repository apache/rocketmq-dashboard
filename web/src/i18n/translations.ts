...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'subscriptionPortfolio.open': { zh: '订阅表达式组合', en: 'Subscription portfolio' },
  'subscriptionPortfolio.title': {
    zh: '消费者订阅表达式组合',
    en: 'Consumer subscription portfolio',
  },
  'subscriptionPortfolio.description': {
    zh: '跨消费组汇总订阅表达式、过滤模式和一致性，单组失败不会中断整体检查。',
    en: 'Aggregate expressions, filter modes, and consistency across consumer groups without letting one failed group stop the report.',
  },
  'subscriptionPortfolio.coverage': {
    zh: '已检查 {inspected}/{available} 个消费组；失败 {failed} 个；因 100 组上限省略 {omitted} 个。',
    en: 'Inspected {inspected}/{available} groups; {failed} failed; {omitted} omitted by the 100-group cap.',
  },
  'subscriptionPortfolio.ALL': { zh: '订阅全部', en: 'All messages' },
  'subscriptionPortfolio.TAG_SET': { zh: 'Tag 集合', en: 'Tag set' },
  'subscriptionPortfolio.SQL': { zh: 'SQL 表达式', en: 'SQL expression' },
  'subscriptionPortfolio.EMPTY': { zh: '空表达式', en: 'Empty expression' },
  'subscriptionPortfolio.OTHER': { zh: '其他表达式', en: 'Other expression' },
  'subscriptionPortfolio.expressionKind': { zh: '表达式类别', en: 'Expression kind' },
  'subscriptionPortfolio.filterMode': { zh: '过滤模式', en: 'Filter mode' },
  'subscriptionPortfolio.type': { zh: '订阅类型', en: 'Subscription type' },
  'subscriptionPortfolio.consistency': { zh: '一致性', en: 'Consistency' },
  'subscriptionPortfolio.subscriptions': { zh: '订阅数', en: 'Subscriptions' },
  'subscriptionPortfolio.groups': { zh: '消费组数', en: 'Groups' },
  'subscriptionPortfolio.topics': { zh: 'Topic 数', en: 'Topics' },
  'subscriptionPortfolio.profiles': { zh: '表达式组合', en: 'Profiles' },
  'subscriptionPortfolio.inconsistent': { zh: '不一致订阅', en: 'Inconsistent' },
  'subscriptionPortfolio.inspectedGroups': { zh: '已检查消费组', en: 'Inspected groups' },
  'subscriptionPortfolio.sampleGroups': { zh: '消费组样例', en: 'Group samples' },
  'subscriptionPortfolio.sampleTopics': { zh: 'Topic 样例', en: 'Topic samples' },
  'subscriptionPortfolio.sampleExpressions': { zh: '表达式样例', en: 'Expression samples' },
  'subscriptionPortfolio.attention': { zh: '需关注', en: 'Needs attention' },
  'subscriptionPortfolio.search': {
    zh: '搜索消费组、Topic 或表达式',
    en: 'Search groups, topics, or expressions',
  },
  'subscriptionPortfolio.emptyGroups': {
    zh: '无订阅消费组：{count}',
    en: 'Groups without subscriptions: {count}',
  },
  'subscriptionPortfolio.empty': {
    zh: '没有符合条件的订阅组合',
    en: 'No matching subscription profiles',
  },
  'subscriptionPortfolio.loadFailed': {
    zh: '订阅表达式组合加载失败',
    en: 'Failed to load the subscription portfolio.',
  },
