...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'consumer.currentTotalLag': { zh: '当前总堆积', en: 'Current Total Backlog' },
  'consumer.netOffsetDelta': { zh: '位点净变化', en: 'Net Offset Change' },
  'consumer.previewComplete': { zh: '完整', en: 'Complete' },
  'consumer.previewFailed': { zh: '位点预览失败', en: 'Offset preview failed' },
  'consumer.previewHint': { zh: '预览不会修改 broker 位点，仅计算目标时间对应的 Queue offset。', en: 'The preview does not modify broker offsets; it only computes the Queue offset for the target time.' },
  'consumer.previewImpactBtn': { zh: '预览影响', en: 'Preview Impact' },
  'consumer.previewIncomplete': { zh: '不完整', en: 'Incomplete' },
  'consumer.previewLimited': { zh: '有限', en: 'Limited' },
  'consumer.projectedTotalLag': { zh: '重置后总堆积', en: 'Backlog After Reset' },
  'consumer.queueCount': { zh: 'Queue 数', en: 'Queues' },
  'consumer.quickSelect': { zh: '快捷选择', en: 'Quick Select' },
  'consumer.resetStatus': { zh: '预览状态', en: 'Preview Status' },
  'consumer.resetTimePlaceholder': { zh: '选择重置时间点', en: 'Select the reset time' },
  'consumer.resetToTime': { zh: '重置到以下时间点', en: 'Reset to the following time' },
  'consumer.rewindQueueCount': { zh: '回放 Queue', en: 'Rewind Queues' },
  'consumer.skipQueueCount': { zh: '跳过 Queue', en: 'Skip Queues' },
  'consumer.time12hAgo': { zh: '12 小时前', en: '12 hours ago' },
  'consumer.time1dAgo': { zh: '1 天前', en: '1 day ago' },
  'consumer.time1hAgo': { zh: '1 小时前', en: '1 hour ago' },
  'consumer.time3dAgo': { zh: '3 天前', en: '3 days ago' },
  'consumer.time3hAgo': { zh: '3 小时前', en: '3 hours ago' },
  'consumer.time6hAgo': { zh: '6 小时前', en: '6 hours ago' },
