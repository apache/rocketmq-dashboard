...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'topic.routeDiagnosis': { zh: '路由诊断', en: 'Route Diagnosis' },
  'topic.runDiagnosis': { zh: '运行诊断', en: 'Run Diagnosis' },
  'topic.fetchAll': { zh: '加载全部 Topic', en: 'Load All Topics' },
  'topic.routeHealth': { zh: '路由健康度', en: 'Route Health' },
  'topic.findings': { zh: '诊断结论', en: 'Findings' },
  'topic.brokerCount': { zh: 'Broker 数量', en: 'Broker Count' },
  'topic.totalWriteQueues': { zh: '写队列总数', en: 'Total Write Queues' },
  'topic.totalReadQueues': { zh: '读队列总数', en: 'Total Read Queues' },
  'topic.queueBalance': { zh: '队列均衡', en: 'Queue Balance' },
  'topic.healthy': { zh: '健康', en: 'Healthy' },
  'topic.warning': { zh: '告警', en: 'Warning' },
  'topic.error': { zh: '异常', en: 'Error' },
  'topic.balanced': { zh: '均衡', en: 'Balanced' },
  'topic.unbalanced': { zh: '不均衡', en: 'Unbalanced' },
