...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'alertPortfolio.open': { zh: '规则审查', en: 'Review Portfolio' },
  'alertPortfolio.title': { zh: '告警规则组合审查', en: 'Alert Rule Portfolio Review' },
  'alertPortfolio.description': {
    zh: '基于全量规则快照识别跨分页的重复评估、重名、通知缺失、已删除实例引用和仅禁用监控范围。不同阈值不会被简单判定为冲突。',
    en: 'Review the complete rule snapshot for duplicate evaluations, duplicate names, missing notifications, deleted instance references, and disabled-only scopes. Different thresholds are not treated as conflicts.',
  },
  'alertPortfolio.fullInventory': {
    zh: '审查读取既有全量导出契约，不受当前列表分页和筛选影响，也不会修改任何规则。',
    en: 'The review uses the existing complete export contract, independent of list pagination and filters, and never mutates rules.',
  },
  'alertPortfolio.review': { zh: '开始审查', en: 'Run review' },
  'alertPortfolio.loadFailed': {
    zh: '全量规则加载失败，请稍后重试',
    en: 'Failed to load the complete rule set.',
  },
  'alertPortfolio.notReviewed': {
    zh: '尚未审查规则组合',
    en: 'The rule portfolio has not been reviewed.',
  },
  'alertPortfolio.total': { zh: '规则总数', en: 'Total rules' },
  'alertPortfolio.enabled': { zh: '启用规则', en: 'Enabled rules' },
  'alertPortfolio.affected': { zh: '受影响规则', en: 'Affected rules' },
  'alertPortfolio.critical': { zh: '高风险项', en: 'Critical issues' },
  'alertPortfolio.warning': { zh: '关注项', en: 'Warnings' },
  'alertPortfolio.severity': { zh: '级别', en: 'Severity' },
  'alertPortfolio.issue': { zh: '问题类型', en: 'Issue type' },
  'alertPortfolio.rules': { zh: '涉及规则', en: 'Rules' },
  'alertPortfolio.scope': { zh: '监控范围', en: 'Scope' },
  'alertPortfolio.evidence': { zh: '依据', en: 'Evidence' },
  'alertPortfolio.ruleName': { zh: '规则名称', en: 'Rule name' },
  'alertPortfolio.status': { zh: '状态', en: 'Status' },
  'alertPortfolio.metric': { zh: '指标', en: 'Metric' },
  'alertPortfolio.condition': { zh: '评估条件', en: 'Condition' },
  'alertPortfolio.channels': { zh: '通知渠道', en: 'Channels' },
  'alertPortfolio.noIssues': { zh: '未发现问题', en: 'No issue found' },
  'alertPortfolio.search': { zh: '搜索规则、指标或范围', en: 'Search rule, metric, or scope' },
  'alertPortfolio.stateFilter': { zh: '启用状态筛选', en: 'Filter enabled state' },
  'alertPortfolio.severityFilter': { zh: '风险级别筛选', en: 'Filter severity' },
  'alertPortfolio.issueFilter': { zh: '问题类型筛选', en: 'Filter issue type' },
  'alertPortfolio.allStates': { zh: '全部状态', en: 'All states' },
  'alertPortfolio.allSeverities': { zh: '全部级别', en: 'All severities' },
  'alertPortfolio.allIssues': { zh: '全部问题', en: 'All issues' },
  'alertPortfolio.export': { zh: '导出审查结果', en: 'Export review' },
  'alertPortfolio.exported': {
    zh: '已导出 {count} 条规则审查结果',
    en: 'Exported {count} reviewed rules.',
  },
  'alertPortfolio.visible': {
    zh: '当前筛选显示 {count} 条规则',
    en: '{count} rules match the filters.',
  },
  'alertPortfolio.issueTab': { zh: '问题清单 ({count})', en: 'Issues ({count})' },
  'alertPortfolio.ruleTab': { zh: '规则明细 ({count})', en: 'Rules ({count})' },
  'alertPortfolio.severity.CRITICAL': { zh: '高风险', en: 'Critical' },
  'alertPortfolio.severity.WARNING': { zh: '关注', en: 'Warning' },
  'alertPortfolio.severity.INFO': { zh: '提示', en: 'Info' },
  'alertPortfolio.severity.NONE': { zh: '正常', en: 'Healthy' },
  'alertPortfolio.issue.EXACT_DUPLICATE': { zh: '完全重复评估', en: 'Exact duplicate evaluation' },
  'alertPortfolio.issue.DUPLICATE_NAME': { zh: '规则名称重复', en: 'Duplicate rule name' },
  'alertPortfolio.issue.NO_CHANNELS': { zh: '启用但无通知渠道', en: 'Enabled without channels' },
  'alertPortfolio.issue.UNKNOWN_INSTANCE': {
    zh: '引用实例不存在',
    en: 'Unknown instance reference',
  },
  'alertPortfolio.issue.DISABLED_ONLY_SCOPE': {
    zh: '监控范围仅有禁用规则',
    en: 'Disabled-only scope',
  },
