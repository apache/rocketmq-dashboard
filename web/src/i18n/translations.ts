...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'settings.dataSourceCoverageTitle': {
    zh: '数据源实例覆盖分析',
    en: 'Data source instance coverage',
  },
  'settings.dataSourceCoverageHealthy': { zh: '覆盖正常', en: 'Healthy' },
  'settings.dataSourceCoverageWarning': { zh: '需要关注', en: 'Needs attention' },
  'settings.dataSourceCoverageCritical': { zh: '存在缺口', en: 'Coverage gaps' },
  'settings.dataSourceCoverageEmpty': { zh: '暂无分析', en: 'No coverage data' },
  'settings.dataSourceCoverageCovered': { zh: '已覆盖实例', en: 'Covered instances' },
  'settings.dataSourceCoverageVerified': { zh: '已验证实例', en: 'Verified instances' },
  'settings.dataSourceCoverageGlobalSources': { zh: '全局数据源', en: 'Global sources' },
  'settings.dataSourceCoverageScopedSources': { zh: '实例级数据源', en: 'Scoped sources' },
  'settings.dataSourceCoverageMissing': { zh: '缺失覆盖', en: 'Missing coverage' },
  'settings.dataSourceCoverageConflicts': { zh: '重叠覆盖', en: 'Conflicts' },
  'settings.dataSourceCoverageViewDetails': { zh: '查看覆盖明细', en: 'View coverage' },
  'settings.dataSourceCoverageOverview': { zh: '覆盖概览', en: 'Coverage overview' },
  'settings.dataSourceCoverageSources': { zh: '数据源', en: 'Data sources' },
  'settings.dataSourceCoverageInstances': { zh: '实例', en: 'Instances' },
  'settings.dataSourceCoverageUntestedSources': { zh: '未检测数据源', en: 'Untested sources' },
  'settings.dataSourceCoverageUnhealthySources': { zh: '不可用数据源', en: 'Unavailable sources' },
  'settings.dataSourceCoverageInstance': { zh: '实例', en: 'Instance' },
  'settings.dataSourceCoverageEffectiveSources': {
    zh: '生效数据源',
    en: 'Effective data sources',
  },
  'settings.dataSourceCoverageIssues': { zh: '覆盖问题', en: 'Coverage issues' },
  'settings.dataSourceCoverageNoIssues': { zh: '无问题', en: 'No issues' },
  'settings.dataSourceCoverageScoped': { zh: '实例级', en: 'Scoped' },
  'settings.dataSourceCoverageInstanceCount': { zh: '覆盖实例数', en: 'Instances covered' },
  'settings.dataSourceCoverageHealth': { zh: '健康状态', en: 'Health' },
  'settings.dataSourceCoverageUnhealthy': { zh: '不可用', en: 'Unavailable' },
  'settings.dataSourceCoverageNoInstances': { zh: '没有实例可分析', en: 'No instances' },
  'settings.dataSourceCoverageNoSources': { zh: '没有配置数据源', en: 'No data sources' },
  'settings.dataSourceCoverageUncovered': { zh: '未覆盖', en: 'Uncovered' },
  'settings.dataSourceCoverageNoUsable': { zh: '无可用数据源', en: 'No usable source' },
  'settings.dataSourceCoverageConflict': { zh: '同类型重叠', en: 'Same-type overlap' },
  'settings.dataSourceCoverageOnlyUntested': { zh: '仅未检测数据源', en: 'Only untested sources' },
  'settings.dataSourceCoverageStaleInstance': {
    zh: '引用未知实例',
    en: 'Unknown instance binding',
  },
  'settings.dataSourceCoverageUnhealthySource': {
    zh: '包含不可用数据源',
    en: 'Unavailable source',
  },
  'settings.dataSourceCoverageDuplicateTarget': { zh: '重复 endpoint', en: 'Duplicate endpoint' },
