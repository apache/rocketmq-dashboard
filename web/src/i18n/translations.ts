...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'message.queryErrorFallback': { zh: '消息查询失败，请稍后重试', en: 'Message query failed, please retry later' },
  'message.traceErrorFallback': { zh: '消息轨迹加载失败，请稍后重试', en: 'Failed to load the message trace, please retry later' },
  'message.actions': { zh: '操作', en: 'Actions' },
  'message.traceTab': { zh: '消息轨迹', en: 'Message Trace' },
  'message.runTrace': { zh: '查询轨迹', en: 'Query Trace' },
  'message.traceLoading': { zh: '正在加载轨迹数据…', en: 'Loading trace data…' },
  'message.traceEmpty': { zh: '暂无轨迹数据', en: 'No trace data' },
  'message.searchSubtitle': { zh: '按 Topic、Key 或 Message ID 检索消息', en: 'Search messages by Topic, Key or Message ID' },
  'message.reset': { zh: '重置', en: 'Reset' },
  'message.serverHistory': { zh: '服务端历史', en: 'Server History' },
  'message.scanLimitWarning': { zh: '查询结果达到服务端扫描上限，当前总数可能不完整。', en: 'Results hit the server scan limit; the total may be incomplete.' },
  'message.detailTitle': { zh: '消息详情', en: 'Message Details' },
  'message.directConsumeButton': { zh: '直接消费', en: 'Consume' },
  'message.directConsumeTitle': { zh: '直接消费消息', en: 'Directly Consume Message' },
  'message.consumeRun': { zh: '执行', en: 'Run' },
  'message.consumeNotice': { zh: 'Broker 会请求指定在线客户端立即消费该消息。', en: 'The Broker asks the specified online client to consume this message immediately.' },
  'message.consumeNoticeDesc': { zh: '这不是向 Topic 重新发送消息；Broker 返回的消费结果会原样显示。', en: 'This does not resend the message to the Topic; the consumption result returned by the Broker is shown as-is.' },
  'message.consumeGroupPlaceholder': { zh: '目标消费者组', en: 'Target consumer group' },
  // ─── BrokerCluster ───
};
