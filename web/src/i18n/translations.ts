...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'cluster.k8sDiscoverAction': { zh: '从 K8s 发现', en: 'Discover from K8s' },
  'cluster.k8sDiscoveryTitle': {
    zh: '发现 Kubernetes NameServer',
    en: 'Discover Kubernetes NameServers',
  },
  'cluster.k8sDiscoveryReadOnly': {
    zh: '发现操作仅读取指定 Namespace，不会修改 Kubernetes 资源或自动保存注册记录。',
    en: 'Discovery only reads the selected namespace. It does not modify Kubernetes resources or save registry entries automatically.',
  },
  'cluster.k8sNamespaceRequired': { zh: '请输入 K8s Namespace', en: 'Enter a K8s namespace' },
  'cluster.k8sDiscoveryEmpty': {
    zh: '未发现 NameServer 候选',
    en: 'No NameServer candidates found',
  },
  'cluster.k8sDiscoveryPending': {
    zh: '输入 Namespace 后开始发现',
    en: 'Enter a namespace to discover',
  },
  'cluster.k8sDiscoveryFailed': { zh: 'K8s 发现失败', en: 'K8s discovery failed' },
  'cluster.k8sDiscoverySource': { zh: '来源', en: 'Source' },
  'cluster.k8sDiscoverySource.SERVICE_PORT': { zh: 'Service 端口', en: 'Service port' },
  'cluster.k8sDiscoverySource.SERVICE_HINT': { zh: 'Service 特征', en: 'Service hint' },
  'cluster.k8sDiscoverySource.ENDPOINT_SLICE': { zh: 'EndpointSlice', en: 'EndpointSlice' },
  'cluster.k8sDiscoverySource.POD_LABEL': { zh: 'Pod 标签', en: 'Pod label' },
  'cluster.k8sDiscoverySource.POD_IMAGE': { zh: 'Pod 镜像兜底', en: 'Pod image fallback' },
  'cluster.k8sDiscoveryConfidence': { zh: '置信度', en: 'Confidence' },
  'cluster.k8sDiscoveryConfidence.HIGH': { zh: '高', en: 'High' },
  'cluster.k8sDiscoveryConfidence.MEDIUM': { zh: '中', en: 'Medium' },
  'cluster.k8sDiscoveryConfidence.LOW': { zh: '低', en: 'Low' },
  'cluster.k8sDiscoveryStability': { zh: '地址稳定性', en: 'Address stability' },
  'cluster.k8sDiscoveryStable': { zh: '稳定', en: 'Stable' },
  'cluster.k8sDiscoveryUnstable': { zh: '临时地址', en: 'Ephemeral' },
  'cluster.k8sDiscoveryUse': { zh: '使用', en: 'Use' },
  'cluster.k8sDiscoveredDescription': {
    zh: '从 Kubernetes 自动发现（{source}）',
    en: 'Discovered from Kubernetes ({source})',
  },
