...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'audit.summary.matchedRecords': { zh: '匹配记录', en: 'Matched Records' },
  'audit.summary.successRate': { zh: '成功率', en: 'Success Rate' },
  'audit.summary.failedPartial': { zh: '失败 / 部分成功', en: 'Failed / Partial' },
  'audit.summary.operators': { zh: '操作人数', en: 'Operators' },
  'audit.summary.topOperations': { zh: '高频操作', en: 'Top Operations' },
  'audit.summary.resourceDistribution': { zh: '资源类型分布', en: 'Resource Types' },
