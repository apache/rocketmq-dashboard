...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'alerts.importPreviewTitle': { zh: '导入预览', en: 'Import Preview' },
  'alerts.importPreviewLoading': { zh: '正在校验告警规则...', en: 'Validating alert rules...' },
  'alerts.importPreviewFailed': {
    zh: '无法生成导入预览，请检查文件内容后重试',
    en: 'Could not generate the import preview. Check the file and try again.',
  },
  'alerts.importApply': { zh: '应用导入', en: 'Apply Import' },
  'alerts.importApplySuccess': {
    zh: '新增 {created} 条，覆盖 {replaced} 条，跳过 {skipped} 条',
    en: 'Created {created}, replaced {replaced}, skipped {skipped}',
  },
  'alerts.importApplyFailed': {
    zh: '应用导入失败，预览已刷新',
    en: 'Failed to apply the import. The preview has been refreshed.',
  },
  'alerts.importRow': { zh: '行号', en: 'Row' },
  'alerts.importDetails': { zh: '详情', en: 'Details' },
  'alerts.importStatusNEW': { zh: '新增', en: 'New' },
  'alerts.importStatusDUPLICATE': { zh: '重复', en: 'Duplicate' },
  'alerts.importStatusINVALID': { zh: '无效', en: 'Invalid' },
  'alerts.importDuplicateOf': {
    zh: '与现有规则“{name}”条件相同',
    en: 'Matches the existing rule "{name}"',
  },
  'alerts.importTotalCount': { zh: '共 {count} 条', en: '{count} total' },
  'alerts.importNewCount': { zh: '新增 {count} 条', en: '{count} new' },
  'alerts.importDuplicateCount': { zh: '重复 {count} 条', en: '{count} duplicate' },
  'alerts.importInvalidCount': { zh: '无效 {count} 条', en: '{count} invalid' },
  'alerts.importConflictStrategy': { zh: '重复规则处理', en: 'Duplicate handling' },
  'alerts.importStrategyFail': { zh: '发现重复则停止', en: 'Stop on duplicates' },
  'alerts.importStrategySkip': { zh: '跳过重复', en: 'Skip duplicates' },
  'alerts.importStrategyReplace': { zh: '覆盖现有', en: 'Replace existing' },
  'alerts.importInvalidBlocked': {
    zh: '文件包含无效规则，修正后才能应用导入',
    en: 'Fix invalid rules in the file before applying the import.',
  },
  'alerts.importDuplicateBlocked': {
    zh: '文件包含重复规则，请选择跳过或覆盖后再应用',
    en: 'Choose skip or replace before applying an import with duplicates.',
  },
