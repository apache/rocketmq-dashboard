...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'instance.action': { zh: '操作', en: 'Actions' },
  'instance.deleteCloudWarning': { zh: '仅从 Studio 移除该实例记录，不会释放云上的 RocketMQ 实例。', en: 'This only removes the record from Studio; the cloud RocketMQ instance is not released.' },
  'instance.openSource': { zh: '开源版', en: 'Open Source' },
  'instance.region': { zh: '地域', en: 'Region' },
  'instance.type': { zh: '类型', en: 'Type' },
