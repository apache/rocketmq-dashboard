...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'llmReadiness.open': { zh: '模型目录就绪度', en: 'Model catalog readiness' },
  'llmReadiness.title': { zh: 'AI 模型目录就绪度', en: 'AI model catalog readiness' },
  'llmReadiness.description': {
    zh: '基于服务端已保存配置与最新模型目录生成只读检查，不显示或读取 API Key 内容。',
    en: 'Read-only checks based on saved server configuration and the latest catalog; API key values are never displayed.',
  },
  'llmReadiness.ready': {
    zh: '当前 AI 配置具备基础就绪条件',
    en: 'The current AI configuration meets basic readiness checks.',
  },
  'llmReadiness.notReady': {
    zh: '当前 AI 配置存在阻断项',
    en: 'The current AI configuration has blocking issues.',
  },
  'llmReadiness.models': { zh: '目录模型数', en: 'Catalog models' },
  'llmReadiness.errors': { zh: '阻断项', en: 'Errors' },
  'llmReadiness.warnings': { zh: '警告项', en: 'Warnings' },
  'llmReadiness.provider': { zh: 'Provider', en: 'Provider' },
  'llmReadiness.engine': { zh: '执行引擎', en: 'Engine' },
  'llmReadiness.selectedModel': { zh: '当前模型', en: 'Selected model' },
  'llmReadiness.source': { zh: '目录来源', en: 'Catalog source' },
  'llmReadiness.endpoint': { zh: 'Endpoint 主机', en: 'Endpoint host' },
  'llmReadiness.credential': { zh: '密钥已配置', en: 'Credential configured' },
  'llmReadiness.enabled': { zh: '功能已启用', en: 'Feature enabled' },
  'llmReadiness.serverReady': { zh: '服务端就绪', en: 'Server ready' },
  'llmReadiness.issues': { zh: '就绪度问题', en: 'Readiness issues' },
  'llmReadiness.catalog': { zh: '模型目录', en: 'Model catalog' },
  'llmReadiness.severity': { zh: '级别', en: 'Severity' },
  'llmReadiness.issue': { zh: '问题', en: 'Issue' },
  'llmReadiness.detail': { zh: '详情', en: 'Detail' },
  'llmReadiness.modelId': { zh: '模型 ID', en: 'Model ID' },
  'llmReadiness.modelName': { zh: '模型名称', en: 'Model name' },
  'llmReadiness.selected': { zh: '当前使用', en: 'Selected' },
  'llmReadiness.INFO': { zh: '信息', en: 'Info' },
  'llmReadiness.WARNING': { zh: '警告', en: 'Warning' },
  'llmReadiness.ERROR': { zh: '错误', en: 'Error' },
  'llmReadiness.source.provider': { zh: 'Provider 实时目录', en: 'Provider catalog' },
  'llmReadiness.source.builtin': { zh: '内置目录', en: 'Built-in catalog' },
  'llmReadiness.source.fallback': { zh: '回退目录', en: 'Fallback catalog' },
  'llmReadiness.source.unknown': { zh: '未知', en: 'Unknown' },
  'llmReadiness.issue.DISABLED': { zh: 'AI 功能未启用', en: 'AI feature is disabled' },
  'llmReadiness.issue.SERVER_NOT_READY': { zh: '服务端报告未就绪', en: 'Server reports not ready' },
  'llmReadiness.issue.MODEL_MISSING': { zh: '未选择模型', en: 'No model selected' },
  'llmReadiness.issue.ENDPOINT_MISSING': {
    zh: '未配置 API Endpoint',
    en: 'API endpoint is missing',
  },
  'llmReadiness.issue.ENDPOINT_INVALID': {
    zh: 'API Endpoint 格式无效',
    en: 'API endpoint is invalid',
  },
  'llmReadiness.issue.CREDENTIAL_MISSING': {
    zh: 'Provider 所需密钥未配置',
    en: 'Required provider credential is missing',
  },
  'llmReadiness.issue.AZURE_DEPLOYMENT_MISSING': {
    zh: '缺少 Azure Deployment',
    en: 'Azure deployment is missing',
  },
  'llmReadiness.issue.AZURE_API_VERSION_MISSING': {
    zh: '缺少 Azure API Version',
    en: 'Azure API version is missing',
  },
  'llmReadiness.issue.BEDROCK_REGION_MISSING': {
    zh: '缺少 Bedrock Region',
    en: 'Bedrock region is missing',
  },
  'llmReadiness.issue.CATALOG_REQUEST_FAILED': {
    zh: '模型目录请求失败',
    en: 'Model catalog request failed',
  },
  'llmReadiness.issue.CATALOG_FALLBACK': {
    zh: '正在使用回退目录',
    en: 'Fallback catalog is in use',
  },
  'llmReadiness.issue.CATALOG_BUILTIN': {
    zh: '正在使用内置目录',
    en: 'Built-in catalog is in use',
  },
  'llmReadiness.issue.CATALOG_EMPTY': { zh: '模型目录为空', en: 'Model catalog is empty' },
  'llmReadiness.issue.MODEL_NOT_IN_CATALOG': {
    zh: '当前模型不在目录中',
    en: 'Selected model is not in the catalog',
  },
  'llmReadiness.issue.CATALOG_WARNING': {
    zh: '模型目录返回警告',
    en: 'Model catalog returned a warning',
  },
  'llmReadiness.noIssues': { zh: '未发现就绪度问题', en: 'No readiness issues found' },
  'llmReadiness.emptyCatalog': { zh: '模型目录为空', en: 'The model catalog is empty' },
  'llmReadiness.loadFailed': {
    zh: '模型目录就绪度加载失败',
    en: 'Failed to load model catalog readiness.',
  },
