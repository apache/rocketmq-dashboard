...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'instance.batchDeleteIntro': { zh: '将删除：', en: 'Will delete: ' },
  'instance.batchDeleteTitle': { zh: '确认删除选中的 {count} 个实例？', en: 'Delete the {count} selected instances?' },
  'instance.deletePartial': { zh: '已删除 {deleted} 个，{failed} 个未能删除：{details}', en: 'Deleted {deleted}; {failed} failed to delete: {details}' },
