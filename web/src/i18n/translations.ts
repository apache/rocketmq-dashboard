...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'fleetInventory.open': { zh: '资源检索', en: 'Resource Inventory' },
  'fleetInventory.title': { zh: '跨实例资源检索', en: 'Fleet Resource Inventory' },
  'fleetInventory.description': {
    zh: '汇总所选实例的 Topic 与消费组，定位同名资源的部署范围，并保留部分加载失败时的成功结果。',
    en: 'Aggregate Topics and Consumer Groups across selected instances, locate shared names, and preserve successful results when part of the fleet is unavailable.',
  },
  'fleetInventory.instances': { zh: '检索实例', en: 'Instances to scan' },
  'fleetInventory.selectInstance': {
    zh: '请至少选择一个实例',
    en: 'Select at least one instance.',
  },
  'fleetInventory.noInstances': { zh: '暂无可检索的实例', en: 'No instances are available.' },
  'fleetInventory.load': { zh: '加载资源', en: 'Load resources' },
  'fleetInventory.loadFailed': {
    zh: '资源检索失败，请重试',
    en: 'Failed to load the resource inventory. Please retry.',
  },
  'fleetInventory.partialFailure': {
    zh: '有 {count} 个资源清单加载失败，成功结果仍可检索。',
    en: '{count} resource inventories failed to load. Successful results remain searchable.',
  },
  'fleetInventory.exported': {
    zh: '已导出 {count} 条资源记录',
    en: 'Exported {count} resource rows.',
  },
  'fleetInventory.loadedInstances': { zh: '已加载实例', en: 'Loaded instances' },
  'fleetInventory.topics': { zh: 'Topic 记录', en: 'Topic rows' },
  'fleetInventory.groups': { zh: '消费组记录', en: 'Consumer Group rows' },
  'fleetInventory.sharedNames': { zh: '跨实例同名', en: 'Shared names' },
  'fleetInventory.visible': { zh: '当前结果', en: 'Visible rows' },
  'fleetInventory.kind': { zh: '资源类型', en: 'Resource type' },
  'fleetInventory.topic': { zh: 'Topic', en: 'Topic' },
  'fleetInventory.group': { zh: '消费组', en: 'Consumer Group' },
  'fleetInventory.name': { zh: '资源名称', en: 'Resource name' },
  'fleetInventory.instance': { zh: '实例', en: 'Instance' },
  'fleetInventory.vendor': { zh: '厂商', en: 'Vendor' },
  'fleetInventory.configuration': { zh: '配置摘要', en: 'Configuration' },
  'fleetInventory.occurrences': { zh: '实例数', en: 'Instance count' },
  'fleetInventory.search': {
    zh: '搜索名称、实例、集群或配置',
    en: 'Search name, instance, cluster, or configuration',
  },
  'fleetInventory.kindFilter': { zh: '资源类型筛选', en: 'Filter resource type' },
  'fleetInventory.instanceFilter': { zh: '实例筛选', en: 'Filter instance' },
  'fleetInventory.vendorFilter': { zh: '厂商筛选', en: 'Filter vendor' },
  'fleetInventory.allKinds': { zh: '全部资源', en: 'All resources' },
  'fleetInventory.allInstances': { zh: '全部实例', en: 'All instances' },
  'fleetInventory.allVendors': { zh: '全部厂商', en: 'All vendors' },
  'fleetInventory.sharedOnly': { zh: '仅跨实例同名', en: 'Shared names only' },
  'fleetInventory.export': { zh: '导出结果', en: 'Export results' },
