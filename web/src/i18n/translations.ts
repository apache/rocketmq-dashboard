...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'instanceImport.done': { zh: '导入完成：共同步 {total} 个实例（新导入 {imported}，已存在跳过 {skipped}）', en: 'Import complete: {total} instances synced ({imported} new, {skipped} already present)' },
  'instanceImport.allPresent': { zh: '云上实例均已在 Studio 中（共 {skipped} 个），无需重复导入', en: 'All cloud instances are already in Studio ({skipped}); no re-import needed' },
  'instanceImport.failedSuffix': { zh: '，失败 {failed} 个：{names}', en: ', {failed} failed: {names}' },
  'instanceDelete.cloudWarning': { zh: '云厂商实例仅从 Studio 移除记录，不会释放云上的 RocketMQ 实例；仍有 Topic/Group 的开源实例无法删除。', en: 'Cloud instances are only removed from Studio; the RocketMQ instances in the cloud are not released. Open-source instances still referenced by Topics/Groups cannot be deleted.' },
  'instanceDelete.localWarning': { zh: '仍有 Topic/Group 的开源实例无法删除。', en: 'Open-source instances still referenced by Topics/Groups cannot be deleted.' },
  'instanceDelete.confirmTitle': { zh: '确认删除选中的 {count} 个实例？', en: 'Delete the selected {count} instances?' },
  'instanceDelete.willDelete': { zh: '将删除：{names}。', en: 'Will delete: {names}. ' },
  'instanceDelete.ok': { zh: '删除', en: 'Delete' },
  'instanceAdd.credentialLabel': { zh: '云凭据', en: 'Cloud Credential' },
  'instanceAdd.credentialRequired': { zh: '请选择云凭据', en: 'Select a cloud credential' },
  'instanceAdd.credentialExtra': { zh: '凭据为{vendor}账号的 AK/SK', en: 'Credential is the AK/SK of the {vendor} account' },
  'instanceAdd.aliyun': { zh: '阿里云', en: 'Aliyun' },
  'instanceAdd.tencent': { zh: '腾讯云', en: 'Tencent Cloud' },
  'instanceAdd.gotoCredential': { zh: '前往「设置 - 云凭据管理」添加', en: 'add one in Settings → Cloud Credentials' },
  'instanceAdd.credentialPlaceholder': { zh: '选择已录入的 AK/SK 凭据', en: 'Select a registered AK/SK credential' },
  'instanceAdd.loading': { zh: '加载中…', en: 'Loading…' },
  'instanceAdd.noCredential': { zh: '暂无{vendor}凭据', en: 'No {vendor} credential yet' },
  'instanceAdd.gotoAdd': { zh: '去设置中添加', en: 'add one in Settings' },
  // ─── BrokerCluster ───
};
