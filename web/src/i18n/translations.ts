...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'incidentExplorer.open': { zh: '事件时间线', en: 'Incident Timeline' },
  'incidentExplorer.title': { zh: '告警事件关联时间线', en: 'Alert Incident Timeline' },
  'incidentExplorer.description': {
    zh: '跨分页聚合同一 fingerprint 的 FIRING 与 RESOLVED 事件，展示事件持续时间、确认和通知抑制情况。',
    en: 'Correlate FIRING and RESOLVED events with the same fingerprint across pages, including duration, acknowledgement, and notification suppression.',
  },
  'incidentExplorer.boundary': {
    zh: '优先使用服务端 fingerprint；缺失时仅按规则、实例和完整标签关联；证据不足的事件保持独立。最多读取 10,000 条。',
    en: 'Server fingerprints take precedence. Without one, correlation requires rule, instance, and complete labels; events lacking evidence remain isolated. Up to 10,000 records are loaded.',
  },
  'incidentExplorer.load': { zh: '加载时间线', en: 'Load timeline' },
  'incidentExplorer.loadFailed': {
    zh: '完整告警历史加载失败，请稍后重试',
    en: 'Failed to load complete alert history.',
  },
  'incidentExplorer.empty': {
    zh: '尚未加载事件时间线',
    en: 'The incident timeline has not been loaded.',
  },
  'incidentExplorer.truncated': {
    zh: '历史共有 {total} 条，本次分析最近 {loaded} 条。',
    en: '{total} events exist; this analysis uses the latest {loaded}.',
  },
  'incidentExplorer.incidents': { zh: '事件组', en: 'Incidents' },
  'incidentExplorer.active': { zh: '活跃', en: 'Active' },
  'incidentExplorer.resolved': { zh: '已恢复', en: 'Resolved' },
  'incidentExplorer.suppressed': { zh: '通知已抑制', en: 'Suppressed' },
  'incidentExplorer.unacknowledged': { zh: '未确认事件', en: 'Unacknowledged events' },
  'incidentExplorer.longest': { zh: '最长持续时间', en: 'Longest duration' },
  'incidentExplorer.titleColumn': { zh: '告警标题', en: 'Alert title' },
  'incidentExplorer.status': { zh: '事件状态', en: 'Incident status' },
  'incidentExplorer.level': { zh: '最高级别', en: 'Highest level' },
  'incidentExplorer.domain': { zh: '告警域', en: 'Domain' },
  'incidentExplorer.instance': { zh: '实例', en: 'Instance' },
  'incidentExplorer.source': { zh: '关联依据', en: 'Correlation source' },
  'incidentExplorer.events': { zh: '事件数', en: 'Events' },
  'incidentExplorer.acknowledged': { zh: '已确认', en: 'Acknowledged' },
  'incidentExplorer.duration': { zh: '持续时间', en: 'Duration' },
  'incidentExplorer.lastSeen': { zh: '最近事件', en: 'Last seen' },
  'incidentExplorer.status.ACTIVE': { zh: '活跃', en: 'Active' },
  'incidentExplorer.status.RESOLVED': { zh: '已恢复', en: 'Resolved' },
  'incidentExplorer.status.UNKNOWN': { zh: '状态未知', en: 'Unknown' },
  'incidentExplorer.source.FINGERPRINT': { zh: 'Fingerprint', en: 'Fingerprint' },
  'incidentExplorer.source.RULE_SCOPE': { zh: '规则与标签', en: 'Rule and labels' },
  'incidentExplorer.source.ISOLATED': { zh: '独立事件', en: 'Isolated event' },
  'incidentExplorer.search': {
    zh: '搜索标题、实例或关联键',
    en: 'Search title, instance, or correlation key',
  },
  'incidentExplorer.statusFilter': { zh: '事件状态筛选', en: 'Filter incident status' },
  'incidentExplorer.domainFilter': { zh: '告警域筛选', en: 'Filter domain' },
  'incidentExplorer.levelFilter': { zh: '级别筛选', en: 'Filter level' },
  'incidentExplorer.allStatuses': { zh: '全部事件状态', en: 'All incident statuses' },
  'incidentExplorer.allDomains': { zh: '全部告警域', en: 'All domains' },
  'incidentExplorer.allLevels': { zh: '全部级别', en: 'All levels' },
  'incidentExplorer.unackOnly': { zh: '仅含未确认事件', en: 'Has unacknowledged events' },
  'incidentExplorer.export': { zh: '导出事件组', en: 'Export incidents' },
  'incidentExplorer.exported': { zh: '已导出 {count} 个事件组', en: 'Exported {count} incidents.' },
  'incidentExplorer.visible': { zh: '当前显示 {count} 个事件组', en: 'Showing {count} incidents.' },
  'incidentExplorer.unknownTransition': { zh: '未知状态', en: 'Unknown transition' },
  'incidentExplorer.acked': { zh: '已确认', en: 'Acknowledged' },
  'incidentExplorer.unacked': { zh: '未确认', en: 'Unacknowledged' },
