...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'consumer.broadcasting': { zh: '广播消费', en: 'Broadcast Consume' },
  'consumer.clustering': { zh: '集群消费', en: 'Cluster Consume' },
  'consumer.consumeType': { zh: '消费类型', en: 'Consume Type' },
  'consumer.confirmCreate': { zh: '确认创建', en: 'Confirm Create' },
  'consumer.createBtn': { zh: '创建', en: 'Create' },
  'consumer.createGroup': { zh: '创建 Group', en: 'Create Group' },
  'consumer.createGroupContent': { zh: '将创建消费组 "{name}"', en: 'Consumer group "{name}" will be created' },
  'consumer.globalOrder': { zh: '全局顺序', en: 'Global Order' },
  'consumer.groupNameExample': { zh: '例：cg-order-notify', en: 'e.g. cg-order-notify' },
  'consumer.groupNameRequired': { zh: '请输入 Group 名称', en: 'Enter the group name' },
  'consumer.msgTypeDelay': { zh: '延迟消息', en: 'Delayed Message' },
  'consumer.msgTypeFifo': { zh: '顺序消息', en: 'FIFO Message' },
  'consumer.msgTypeNormal': { zh: '普通消息', en: 'Normal Message' },
  'consumer.msgTypeTransaction': { zh: '事务消息', en: 'Transactional Message' },
  'consumer.namePatternMsg': { zh: '仅支持字母、数字、下划线、短横线、% 和 |', en: 'Only letters, digits, underscores, hyphens, % and | are allowed' },
  'consumer.nameTooLong': { zh: '名称不能超过 {max} 个字符', en: 'Name cannot exceed {max} characters' },
  'consumer.orderType': { zh: '顺序类型', en: 'Order Type' },
  'consumer.partitionOrder': { zh: '分区顺序', en: 'Partition Order' },
  'consumer.selectMsgType': { zh: '选择消息类型', en: 'Select message type' },
