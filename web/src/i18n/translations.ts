...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'consumer.configSaved': { zh: '消费组配置已保存', en: 'Group config saved' },
  'consumer.copyFailed': { zh: '复制失败，请手动复制', en: 'Copy failed, please copy manually' },
  'consumer.copied': { zh: '已复制：{name}', en: 'Copied: {name}' },
  'consumer.deletedGroups': { zh: '已删除 {count} 个 Group', en: 'Deleted {count} groups' },
  'consumer.exportGroupsDone': { zh: 'Group 导出完成', en: 'Group export complete' },
  'consumer.exportGroupsFailed': { zh: '导出 Group 失败，请稍后重试', en: 'Failed to export groups, please retry later' },
  'consumer.groupCreated': { zh: '消费组 {name} 创建成功', en: 'Consumer group "{name}" created' },
  'consumer.importGroupsDone': { zh: '已导入 {created} 个 Group', en: 'Imported {created} groups' },
  'consumer.importGroupsFailed': { zh: '{failed} 个 Group 导入失败', en: '{failed} group(s) failed to import' },
  'consumer.importGroupsPartialFailed': { zh: '已导入 {created} 个 Group，{failed} 个失败', en: 'Imported {created} groups; {failed} failed' },
  'consumer.importGroupsPartialInvalid': { zh: '已导入 {created} 个 Group，{invalid} 行无效已跳过', en: 'Imported {created} groups; {invalid} invalid row(s) skipped' },
  'consumer.loadConfigFailed': { zh: '加载消费组配置失败，请稍后重试', en: 'Failed to load group config, please retry later' },
  'consumer.previewAndConfirmFirst': { zh: '请先预览并确认位点影响', en: 'Preview and confirm the offset impact first' },
  'consumer.previewNotCovering': { zh: '预览未覆盖可重置队列，请检查 Group/Topic 状态', en: 'The preview does not cover resettable queues; check the group/topic status' },
  'consumer.previewedQueues': { zh: '已预览 {count} 个 Queue', en: 'Previewed {count} queues' },
  'consumer.saveConfigFailed': { zh: '保存消费组配置失败，请稍后重试', en: 'Failed to save group config, please retry later' },
  'consumer.selectInstanceFirst': { zh: '请先选择实例', en: 'Select an instance first' },
  'consumer.selectResetTopicFirst': { zh: '请先选择要重置的 Topic', en: 'Select the topic to reset first' },
  'consumer.unavailable': { zh: '不可用', en: 'Unavailable' },
