...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'message.saved.scopeTitle': { zh: '服务端共享命名查询', en: 'Shared server-side named queries' },
  'message.saved.scopeDescription': {
    zh: '实例 {instance} 的查询条件由服务端保存，可跨浏览器与运维人员复用。每实例最多 50 条；应用仅回填表单，不执行查询。',
    en: 'Criteria for {instance} are stored on the server and shared across browsers and operators. Up to 50 per instance. Applying only fills the form.',
  },
  ...
  'message.saved.storageFailed': {
    zh: '保存失败，请检查名称是否重复、是否已达到 50 条上限，或刷新后重试',
    en: 'Save failed. Check for a duplicate name or the 50-query limit, or refresh and retry.',
  },
  'message.saved.loadFailed': {
    zh: '命名查询加载失败，请刷新重试',
    en: 'Failed to load named queries. Refresh to retry.',
  },
