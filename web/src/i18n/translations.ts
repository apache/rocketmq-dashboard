...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'instance.addFailed': { zh: '添加实例失败，请稍后重试', en: 'Failed to add instance, please retry later' },
  'instance.added': { zh: '实例「{name}」添加成功', en: 'Instance "{name}" added' },
  'instance.batchDeleteFailed': { zh: '批量删除失败，请稍后重试', en: 'Failed to delete in batch, please retry later' },
  'instance.cloudInstanceListFailed': { zh: '云实例列表加载失败', en: 'Failed to load the cloud instance list' },
  'instance.credentialListFailed': { zh: '云凭据列表加载失败', en: 'Failed to load the cloud credential list' },
  'instance.deleteFailed': { zh: '删除实例失败，请稍后重试', en: 'Failed to delete instance, please retry later' },
  'instance.deleted': { zh: '已删除', en: 'Deleted' },
  'instance.importFailed': { zh: '一键导入失败，请稍后重试', en: 'Failed to import, please retry later' },
  'instance.importPartial': { zh: '{summary}，失败 {failed} 个：{details}', en: '{summary}, {failed} failed: {details}' },
  'instance.loadFailed': { zh: '实例列表加载失败，请稍后重试', en: 'Failed to load instances, please retry later' },
  'instance.regionListFailed': { zh: '云地域列表加载失败', en: 'Failed to load the cloud region list' },
  'instance.selectCredentialFirst': { zh: '请先选择云凭据', en: 'Select a cloud credential first' },
  'instance.updateFailed': { zh: '更新实例失败，请稍后重试', en: 'Failed to update instance, please retry later' },
