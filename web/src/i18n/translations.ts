...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'settings.notifyReadinessAction': { zh: '渠道就绪度', en: 'Channel readiness' },
  'settings.notifyReadinessTitle': {
    zh: '通知渠道就绪度与批量测试',
    en: 'Notification readiness and batch test',
  },
  'settings.notifyReadinessDescription': {
    zh: '统一检查通知渠道的配置状态，并对已配置渠道执行有界并发测试。',
    en: 'Review channel configuration and test configured channels with bounded concurrency.',
  },
  'settings.notifySavedConfigHint': {
    zh: '测试仅使用服务端已保存配置；Webhook 仅展示主机名，不读取或展示密钥。',
    en: 'Tests use saved server settings only. Webhooks show host names without exposing secrets.',
  },
  'settings.notifyReady': { zh: '可测试', en: 'Ready' },
  'settings.notifyNotConfigured': { zh: '未配置', en: 'Not configured' },
  'settings.notifyTestSuccess': { zh: '测试成功', en: 'Succeeded' },
  'settings.notifyTestFailed': { zh: '测试失败', en: 'Failed' },
  'settings.notifyChannel': { zh: '渠道', en: 'Channel' },
  'settings.notifyEmail': { zh: '邮件', en: 'Email' },
  'settings.notifyDestination': { zh: '目标摘要', en: 'Destination summary' },
  'settings.notifyRecipients': { zh: '收件人数', en: 'Recipients' },
  'settings.notifySigning': { zh: '已配置签名', en: 'Signing configured' },
  'settings.notifyLatency': { zh: '测试耗时', en: 'Test latency' },
  'settings.notifyMessage': { zh: '测试结果', en: 'Test result' },
  'settings.notifyChannels': { zh: '渠道总数', en: 'Channels' },
  'settings.notifyConfigured': { zh: '已配置', en: 'Configured' },
  'settings.notifyRetest': { zh: '重新测试', en: 'Retest' },
  'settings.notifyTestAll': { zh: '测试已配置渠道', en: 'Test configured channels' },
  'settings.notifyBatchFailed': {
    zh: '批量通知测试未能完成',
    en: 'The notification batch test could not be completed.',
  },
  'settings.notifyMissingCount': {
    zh: '仍有 {count} 个通知渠道未配置，批量测试会自动跳过。',
    en: '{count} notification channels are not configured and will be skipped.',
  },
  'settings.notifyAverageLatency': {
    zh: '已测试渠道平均耗时：{value} ms',
    en: 'Average latency across tested channels: {value} ms',
  },
