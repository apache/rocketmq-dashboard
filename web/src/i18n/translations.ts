...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'settings.about.backend': { zh: '后端框架', en: 'Backend Framework' },
  'settings.about.buildTime': { zh: '构建时间', en: 'Build Time' },
  'settings.about.community': { zh: 'RocketMQ 社区', en: 'RocketMQ Community' },
  'settings.about.docs': { zh: '文档中心', en: 'Documentation' },
  'settings.about.frontend': { zh: '前端框架', en: 'Frontend Framework' },
  'settings.about.relatedLinks': { zh: '相关链接', en: 'Related Links' },
  'settings.about.supportedVersions': { zh: 'RocketMQ 支持版本', en: 'Supported RocketMQ Versions' },
