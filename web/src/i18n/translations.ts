...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // ─── Topic route diagnostics ───
  'topic.accessRead': { zh: '读', en: 'Read' },
  'topic.accessWrite': { zh: '写', en: 'Write' },
  'topic.addressTopology': { zh: '地址拓扑', en: 'Address Topology' },
  'topic.addressUnknown': { zh: '地址未知', en: 'Unknown address' },
  'topic.diagnostics': { zh: '诊断', en: 'Diagnostics' },
  'topic.noIssues': { zh: '无', en: 'None' },
  'topic.queueDistribution': { zh: '队列分布', en: 'Queue Distribution' },
  'topic.rebuildButton': { zh: '在 Broker 上重建', en: 'Rebuild on Broker' },
  'topic.recommendedAction': { zh: '建议处理', en: 'Recommended Action' },
  'topic.routeAddressCount': { zh: '{count} 个地址', en: '{count} addresses' },
  'topic.routeBrokerCount': { zh: 'Broker 数', en: 'Brokers' },
  'topic.routeCritical': { zh: '异常', en: 'Abnormal' },
  'topic.routeDiagMessage': { zh: '路由诊断：{status}', en: 'Route diagnostics: {status}' },
  'topic.routeHealthy': { zh: '健康', en: 'Healthy' },
  'topic.routeHealthySummary': { zh: '共 {brokers} 个 Broker，写队列 {write} 个，读队列 {read} 个。', en: '{brokers} Brokers, {write} write queues and {read} read queues total.' },
  'topic.routeIssueSummary': { zh: '发现 {count} 个诊断项，优先处理异常标记的 Broker。', en: 'Found {count} diagnostic items; fix the Brokers marked abnormal first.' },
  'topic.routeIssues': { zh: '诊断项', en: 'Diagnostic Items' },
  'topic.routeQueueBalanced': { zh: '队列均衡', en: 'Balanced' },
  'topic.routeQueueSkew': { zh: '队列差距 写 {write} / 读 {read}', en: 'Queue skew: write {write} / read {read}' },
  'topic.routeReadQueueCount': { zh: '{count} 个读队列', en: '{count} read queues' },
  'topic.routeReadableBrokers': { zh: '可读 Broker', en: 'Readable Brokers' },
  'topic.routeReplicaCount': { zh: 'Replica 数', en: 'Replicas' },
  'topic.routeWarning': { zh: '关注', en: 'Watch' },
  'topic.routeWritableBrokers': { zh: '可写 Broker', en: 'Writable Brokers' },
  'topic.routeWriteQueueCount': { zh: '{count} 个写队列', en: '{count} write queues' },
  // ─── BrokerCluster ───
};
