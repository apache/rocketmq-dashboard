...
const ConsumerPageContent = ({
  ...
  // The subscription-mode filter is applied server-side (loadConsumerGroupPage sends
  // subscriptionMode), so the pager's total and page count stay consistent with the rows.
