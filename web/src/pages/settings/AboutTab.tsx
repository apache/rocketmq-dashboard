...
export const AboutTab = () => {
  ...
  <div style={{ maxWidth: 800 }}>
    <Descriptions column={1} bordered size="small">
      <Descriptions.Item label={t('common.version')}>0.1.0</Descriptions.Item>
      ...
      <Descriptions.Item label={t('about.supportedVersions')}>4.x / 5.x</Descriptions.Item>
    ...
    <Title level={5}>{t('about.relatedLinks')}</Title>
